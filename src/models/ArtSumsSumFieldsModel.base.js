...
/**
 * ArtSumsSumFieldsBase
 * auto generated base class for the model ArtSumsSumFieldsModel.
 *
 * aggregate sum on columns
 */
export const ArtSumsSumFieldsModelBase = ModelBase
  .named('ArtSumsSumFields')
  .props({
...
export class ArtSumsSumFieldsModelSelector extends QueryBuilder {
...
export function selectFromArtSumsSumFields() {
  return new ArtSumsSumFieldsModelSelector()
}

export const artSumsSumFieldsModelPrimitives = selectFromArtSumsSumFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
