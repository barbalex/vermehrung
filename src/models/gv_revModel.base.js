...
/**
 * gv_revBase
 * auto generated base class for the model gv_revModel.
 */
export const gv_revModelBase = ModelBase.named('gv_rev')
  .props({
    __typename: types.optional(types.literal('gv_rev'), 'gv_rev'),
...
export class gv_revModelSelector extends QueryBuilder {
  get _deleted() {
...
export function selectFromgv_rev() {
  return new gv_revModelSelector()
}

export const gv_revModelPrimitives = selectFromgv_rev()._deleted._depth
  ._parent_rev._rev._revisions.changed.changed_by.garten_id.gv_id.person_id
