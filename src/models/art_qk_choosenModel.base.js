...
export const art_qk_choosenModelPrimitives = selectFromart_qk_choosen()._conflicts._deleted._depth._parent_rev._rev._rev_at._revisions.art_id.changed.changed_by.choosen.qk_id.qk_name
