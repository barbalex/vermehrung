...
/**
 * herkunft_rev_max_fieldsBase
 * auto generated base class for the model herkunft_rev_max_fieldsModel.
 */
export const herkunft_rev_max_fieldsModelBase = ModelBase
  .named('herkunft_rev_max_fields')
  .props({
...
export class herkunft_rev_max_fieldsModelSelector extends QueryBuilder {
...
export const herkunft_rev_max_fieldsModelPrimitives = selectFromherkunft_rev_max_fields()._depth._parent_rev._rev._rev_at.bemerkungen.changed.changed_by.gemeinde.herkunft_id.kanton.land.lokalname.nr
