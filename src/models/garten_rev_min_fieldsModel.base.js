...
export const garten_rev_min_fieldsModelPrimitives = selectFromgarten_rev_min_fields()._depth._parent_rev._rev._rev_at.bemerkungen.changed.changed_by.garten_id.name.ort.person_id.plz.strasse
