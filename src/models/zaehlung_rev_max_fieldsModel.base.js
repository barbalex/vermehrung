...
export const zaehlung_rev_max_fieldsModelPrimitives = selectFromzaehlung_rev_max_fields()._depth._parent_rev._rev.bemerkungen.changed.changed_by.datum.kultur_id.rev_id
