...
import { dbAtom, errorsAtom, filterArtAtom } from '../../../../store/index.js'
...
export const SammelLieferungWas = ({ showFilter, row, ifNeeded, saveToDb }) => {
  ...
  }, [db, artFilter._deleted, row.art, showFilter])
