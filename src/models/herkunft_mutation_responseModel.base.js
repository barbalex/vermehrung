 ...
 */
export const herkunft_mutation_responseModelBase = ModelBase.named(
  'herkunft_mutation_response',
)
  .props({
    __typename: types.optional(
      types.literal('herkunft_mutation_response'),
      'herkunft_mutation_response',
    ),
    affected_rows: types.union(types.undefined, types.integer),
    returning: types.union(
      types.undefined,
...
export class herkunft_mutation_responseModelSelector extends QueryBuilder {
  get affected_rows() {
    return this.__attr(`affected_rows`)
  }
  returning(builder) {
    return this.__child(`returning`, herkunftModelSelector, builder)
  }
}
...
export const herkunft_mutation_responseModelPrimitives = selectFromherkunft_mutation_response()
  .affected_rows
