...
/**
 * art_sums_var_pop_fieldsBase
 * auto generated base class for the model art_sums_var_pop_fieldsModel.
 *
 * aggregate var_pop on columns
 */
export const art_sums_var_pop_fieldsModelBase = ModelBase
  .named('art_sums_var_pop_fields')
  .props({
    __typename: types.optional(types.literal("art_sums_var_pop_fields"), "art_sums_var_pop_fields"),
...
export class art_sums_var_pop_fieldsModelSelector extends QueryBuilder {
...
export function selectFromart_sums_var_pop_fields() {
  return new art_sums_var_pop_fieldsModelSelector()
}

export const art_sums_var_pop_fieldsModelPrimitives = selectFromart_sums_var_pop_fields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
