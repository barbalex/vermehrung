...
export class sammel_lieferung_min_fieldsModelSelector extends QueryBuilder {
...
export function selectFromsammel_lieferung_min_fields() {
  return new sammel_lieferung_min_fieldsModelSelector()
}

export const sammel_lieferung_min_fieldsModelPrimitives = selectFromsammel_lieferung_min_fields()._depth._parent_rev._rev._rev_at.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.nach_kultur_id.person_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
