...
/**
 * HerkunftSumsAvgFieldsBase
 * auto generated base class for the model HerkunftSumsAvgFieldsModel.
 *
 * aggregate avg on columns
 */
export const HerkunftSumsAvgFieldsModelBase = ModelBase
  .named('HerkunftSumsAvgFields')
  .props({
...
export class HerkunftSumsAvgFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftSumsAvgFields() {
  return new HerkunftSumsAvgFieldsModelSelector()
}

export const herkunftSumsAvgFieldsModelPrimitives = selectFromHerkunftSumsAvgFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
