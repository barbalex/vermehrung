...
/**
 * HerkunftSumsStddevFieldsBase
 * auto generated base class for the model HerkunftSumsStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const HerkunftSumsStddevFieldsModelBase = ModelBase
  .named('HerkunftSumsStddevFields')
  .props({
    __typename: types.optional(types.literal("herkunft_sums_stddev_fields"), "herkunft_sums_stddev_fields"),
...
export class HerkunftSumsStddevFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftSumsStddevFields() {
  return new HerkunftSumsStddevFieldsModelSelector()
}

export const herkunftSumsStddevFieldsModelPrimitives = selectFromHerkunftSumsStddevFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
