...
export class kultur_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromkultur_max_fields() {
  return new kultur_max_fieldsModelSelector()
}

export const kultur_max_fieldsModelPrimitives = selectFromkultur_max_fields()._depth._parent_rev._rev._rev_at.art_id.bemerkungen.changed.changed_by.garten_id.herkunft_id.von_anzahl_individuen
