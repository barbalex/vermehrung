...
/**
 * ArtSumsVarPopFieldsBase
 * auto generated base class for the model ArtSumsVarPopFieldsModel.
 *
 * aggregate var_pop on columns
 */
export const ArtSumsVarPopFieldsModelBase = ModelBase
  .named('ArtSumsVarPopFields')
  .props({
...
export class ArtSumsVarPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromArtSumsVarPopFields() {
  return new ArtSumsVarPopFieldsModelSelector()
}

export const artSumsVarPopFieldsModelPrimitives = selectFromArtSumsVarPopFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
