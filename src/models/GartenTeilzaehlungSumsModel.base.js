...
/**
 * GartenTeilzaehlungSumsBase
 * auto generated base class for the model GartenTeilzaehlungSumsModel.
 *
 * columns and relationships of "garten_teilzaehlung_sums"
 */
export const GartenTeilzaehlungSumsModelBase = ModelBase
  .named('GartenTeilzaehlungSums')
  .props({
    ...
    kultur_aktiv: types.union(types.undefined, types.null, types.boolean),
    ...
    kultur_erhaltungskultur: types.union(types.undefined, types.null, types.boolean),
    ...
    kultur_letzter_event_geplant: types.union(types.undefined, types.null, types.boolean),
    ...
    zaehlung_prognose: types.union(types.undefined, types.null, types.boolean),
  })
  .views(self => ({
    get store() {
...
export class GartenTeilzaehlungSumsModelSelector extends QueryBuilder {
  get garten_aktiv() { return this.__attr(`garten_aktiv`) }
  ...
  get kultur_aktiv() { return this.__attr(`kultur_aktiv`) }
  ...
  get kultur_erhaltungskultur() { return this.__attr(`kultur_erhaltungskultur`) }
  ...
  get kultur_letzter_event_geplant() { return this.__attr(`kultur_letzter_event_geplant`) }
  ...
  get kultur_zwischenlager() { return this.__attr(`kultur_zwischenlager`) }
