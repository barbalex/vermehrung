...
export const event_revModelPrimitives = selectFromevent_rev()._deleted._depth._parent_rev._rev._rev_at._revisions.beschreibung.changed.changed_by.datum.event_id.geplant.kultur_id.person_id.teilkultur_id
