...
export const herkunft_rev_min_fieldsModelPrimitives = selectFromherkunft_rev_min_fields()._depth._parent_rev._rev.bemerkungen.changed.changed_by.gemeinde.kanton.land.lokalname.nr
