...
import { TeilkulturZaehlungen as Zaehlungen } from './Zaehlungen/index.jsx'
import { TeilkulturEvents as Events } from './Events/index.jsx'
...
export const TeilkulturForm = ({
  ...
  }, [db, kulturFilter, row.kultur, row.kultur_id, showFilter])
  ...
  const saveToDb = async (event) => {
    ...
    if (showFilter) {
      return setFilterValue({ table: 'teilkultur', key: field, value })
    }
  ...
  const showDeleted = teilkulturFilter._deleted !== false || row?._deleted
