...
/**
 * TeilzaehlungRevMaxFieldsBase
 * auto generated base class for the model TeilzaehlungRevMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const TeilzaehlungRevMaxFieldsModelBase = ModelBase
  .named('TeilzaehlungRevMaxFields')
  .props({
    __typename: types.optional(types.literal("teilzaehlung_rev_max_fields"), "teilzaehlung_rev_max_fields"),
...
export class TeilzaehlungRevMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromTeilzaehlungRevMaxFields() {
  return new TeilzaehlungRevMaxFieldsModelSelector()
}

export const teilzaehlungRevMaxFieldsModelPrimitives = selectFromTeilzaehlungRevMaxFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.auspflanzbereit_beschreibung.bemerkungen.changed.changed_by.prognose_von_tz.teilkultur_id.zaehlung_id
