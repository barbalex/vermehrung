...
export const person_file_min_fieldsModelPrimitives = selectFromperson_file_min_fields()._rev_at.beschreibung.changed.file_id.file_mime_type.name.person_id
