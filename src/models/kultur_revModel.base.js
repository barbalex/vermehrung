...
export const kultur_revModelPrimitives = selectFromkultur_rev()._deleted._depth._parent_rev._rev._rev_at._revisions.aktiv.art_id.bemerkungen.changed.changed_by.erhaltungskultur.garten_id.herkunft_id.kultur_id.von_anzahl_individuen.zwischenlager
