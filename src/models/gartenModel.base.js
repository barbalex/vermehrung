 ...
 */
export const gartenModelBase = ModelBase.named('garten')
  .props({
...
export const gartenModelPrimitives = selectFromgarten()._conflicts._deleted
  ._depth._parent_rev._rev._rev_at._revisions.aktiv.bemerkungen.changed
  .changed_by.geom_point.lv95_x.lv95_y.name.ort.person_id.plz.strasse.wgs84_lat
  .wgs84_long
