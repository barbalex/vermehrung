...
export const event_rev_max_fieldsModelPrimitives = selectFromevent_rev_max_fields()._depth._parent_rev._rev.beschreibung.changed.changed_by.datum.kultur_id.person_id.rev_id.teilkultur_id
