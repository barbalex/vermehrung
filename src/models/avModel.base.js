 ...
 */
export const avModelBase = ModelBase.named('av')
  .props({
...
export const avModelPrimitives = selectFromav()._conflicts._deleted._depth
  ._parent_rev._rev._rev_at._revisions.art_id.changed.changed_by.person_id
