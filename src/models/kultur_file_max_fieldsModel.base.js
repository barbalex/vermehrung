...
export const kultur_file_max_fieldsModelPrimitives = selectFromkultur_file_max_fields()._rev_at.beschreibung.changed.file_id.file_mime_type.kultur_id.name
