...
/**
 * SammlungMinFieldsBase
 * auto generated base class for the model SammlungMinFieldsModel.
 *
 * aggregate min on columns
 */
export const SammlungMinFieldsModelBase = ModelBase
  .named('SammlungMinFields')
  .props({
...
export class SammlungMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammlungMinFields() {
  return new SammlungMinFieldsModelSelector()
}

export const sammlungMinFieldsModelPrimitives = selectFromSammlungMinFields()._depth._parent_rev._rev.andere_menge.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.herkunft_id.lv95_x.lv95_y.nr.person_id.von_anzahl_individuen.wgs84_lat.wgs84_long
