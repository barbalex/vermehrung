...
export const teilkultur_rev_min_fieldsModelPrimitives = selectFromteilkultur_rev_min_fields()._depth._parent_rev._rev.bemerkungen.changed.changed_by.kultur_id.name.ort1.ort2.ort3.teilkultur_id
