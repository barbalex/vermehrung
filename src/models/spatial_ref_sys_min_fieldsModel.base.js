...
export class spatial_ref_sys_min_fieldsModelSelector extends QueryBuilder {
...
export function selectFromspatial_ref_sys_min_fields() {
  return new spatial_ref_sys_min_fieldsModelSelector()
}

export const spatial_ref_sys_min_fieldsModelPrimitives = selectFromspatial_ref_sys_min_fields().auth_name.auth_srid.proj4text.srid.srtext
