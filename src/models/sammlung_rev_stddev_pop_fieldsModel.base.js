...
export const sammlung_rev_stddev_pop_fieldsModelPrimitives = selectFromsammlung_rev_stddev_pop_fields()._depth.anzahl_pflanzen.gramm_samen.von_anzahl_individuen
