...
export const sammel_lieferung_sum_fieldsModelPrimitives = selectFromsammel_lieferung_sum_fields()._depth._rev_at.anzahl_auspflanzbereit.anzahl_pflanzen.gramm_samen.von_anzahl_individuen
