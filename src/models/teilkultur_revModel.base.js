...
export const teilkultur_revModelPrimitives = selectFromteilkultur_rev()._deleted._depth._parent_rev._rev._rev_at._revisions.bemerkungen.changed.changed_by.kultur_id.name.ort1.ort2.ort3.teilkultur_id
