...
export const kultur_qkModelPrimitives = selectFromkultur_qk()._conflicts._deleted._depth._parent_rev._rev._rev_at._revisions.beschreibung.changed.changed_by.name.sort.titel
