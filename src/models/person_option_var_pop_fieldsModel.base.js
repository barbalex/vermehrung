...
export class person_option_var_pop_fieldsModelSelector extends QueryBuilder {
  get _depth() { return this.__attr(`_depth`) }
  get _rev_at() { return this.__attr(`_rev_at`) }
}
export function selectFromperson_option_var_pop_fields() {
  return new person_option_var_pop_fieldsModelSelector()
}

export const person_option_var_pop_fieldsModelPrimitives = selectFromperson_option_var_pop_fields()._depth._rev_at
