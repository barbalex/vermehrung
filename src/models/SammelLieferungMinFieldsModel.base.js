...
/**
 * SammelLieferungMinFieldsBase
 * auto generated base class for the model SammelLieferungMinFieldsModel.
 *
 * aggregate min on columns
 */
export const SammelLieferungMinFieldsModelBase = ModelBase
  .named('SammelLieferungMinFields')
  .props({
    __typename: types.optional(types.literal("sammel_lieferung_min_fields"), "sammel_lieferung_min_fields"),
...
export class SammelLieferungMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammelLieferungMinFields() {
  return new SammelLieferungMinFieldsModelSelector()
}

export const sammelLieferungMinFieldsModelPrimitives = selectFromSammelLieferungMinFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.datum.gramm_samen.nach_kultur_id.person_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
