...
export const kultur_option_rev_min_fieldsModelPrimitives = selectFromkultur_option_rev_min_fields()._depth._parent_rev._rev._rev_at.changed.changed_by.kultur_id
