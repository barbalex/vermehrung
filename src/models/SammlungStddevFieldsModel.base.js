...
/**
 * SammlungStddevFieldsBase
 * auto generated base class for the model SammlungStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const SammlungStddevFieldsModelBase = ModelBase
  .named('SammlungStddevFields')
  .props({
...
export class SammlungStddevFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammlungStddevFields() {
  return new SammlungStddevFieldsModelSelector()
}

export const sammlungStddevFieldsModelPrimitives = selectFromSammlungStddevFields()._depth.anzahl_pflanzen.gramm_samen.lv95_x.lv95_y.von_anzahl_individuen.wgs84_lat.wgs84_long
