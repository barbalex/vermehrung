...
export class art_qk_avg_fieldsModelSelector extends QueryBuilder {
  get _depth() { return this.__attr(`_depth`) }
  get _rev_at() { return this.__attr(`_rev_at`) }
  get sort() { return this.__attr(`sort`) }
}
export function selectFromart_qk_avg_fields() {
  return new art_qk_avg_fieldsModelSelector()
}

export const art_qk_avg_fieldsModelPrimitives = selectFromart_qk_avg_fields()._depth._rev_at.sort
