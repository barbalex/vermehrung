...
/**
 * PersonRevMinFieldsBase
 * auto generated base class for the model PersonRevMinFieldsModel.
 *
 * aggregate min on columns
 */
export const PersonRevMinFieldsModelBase = ModelBase
  .named('PersonRevMinFields')
  .props({
...
export class PersonRevMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromPersonRevMinFields() {
  return new PersonRevMinFieldsModelSelector()
}

export const personRevMinFieldsModelPrimitives = selectFromPersonRevMinFields()._depth._parent_rev._rev.account_id.adresszusatz.bemerkungen.changed.changed_by.email.name.nr.ort.plz.strasse.telefon_geschaeft.telefon_mobile.telefon_privat.user_role
