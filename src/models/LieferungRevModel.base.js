...
/**
 * LieferungRevBase
 * auto generated base class for the model LieferungRevModel.
 *
 * columns and relationships of "lieferung_rev"
 */
export const LieferungRevModelBase = ModelBase
  .named('LieferungRev')
  .props({
...
export class LieferungRevModelSelector extends QueryBuilder {
...
export function selectFromLieferungRev() {
  return new LieferungRevModelSelector()
}

export const lieferungRevModelPrimitives = selectFromLieferungRev()._deleted._depth._parent_rev._rev._revisions.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.geplant.gramm_samen.nach_ausgepflanzt.nach_kultur_id.person_id.sammel_lieferung_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
