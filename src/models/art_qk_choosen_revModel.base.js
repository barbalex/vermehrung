 ...
 */
export const art_qk_choosen_revModelBase = ModelBase.named('art_qk_choosen_rev')
  .props({
    __typename: types.optional(
      types.literal('art_qk_choosen_rev'),
      'art_qk_choosen_rev',
    ),
...
export class art_qk_choosen_revModelSelector extends QueryBuilder {
  ...
  get art_qk_choosen_id() {
    return this.__attr(`art_qk_choosen_id`)
  }
  get changed() {
...
export const art_qk_choosen_revModelPrimitives = selectFromart_qk_choosen_rev()
  ._deleted._depth._parent_rev._rev._revisions.art_id.art_qk_choosen_id.changed
  .changed_by.choosen.qk_name
