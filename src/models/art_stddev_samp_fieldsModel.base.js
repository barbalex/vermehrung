...
/**
 * art_stddev_samp_fieldsBase
 * auto generated base class for the model art_stddev_samp_fieldsModel.
 */
export const art_stddev_samp_fieldsModelBase = ModelBase
  .named('art_stddev_samp_fields')
  .props({
