...
/**
 * SammlungVarPopFieldsBase
 * auto generated base class for the model SammlungVarPopFieldsModel.
 *
 * aggregate var_pop on columns
 */
export const SammlungVarPopFieldsModelBase = ModelBase
  .named('SammlungVarPopFields')
  .props({
...
export class SammlungVarPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammlungVarPopFields() {
  return new SammlungVarPopFieldsModelSelector()
}

export const sammlungVarPopFieldsModelPrimitives = selectFromSammlungVarPopFields()._depth.anzahl_pflanzen.gramm_samen.lv95_x.lv95_y.von_anzahl_individuen.wgs84_lat.wgs84_long
