...
export const RootStore = RootStoreBase.props({
  ...
  .actions((self) => {
    ...
    return {
      ...
      logInitialLoading() {
        console.log({
          aeArtLoaded: self.aeArtLoaded,
          artLoaded: self.artLoaded,
          artFileLoaded: self.artFileLoaded,
          artQkLoaded: self.artQkLoaded,
          artQkChoosenLoaded: self.artQkChoosenLoaded,
          avLoaded: self.avLoaded,
          eventLoaded: self.eventLoaded,
          gartenLoaded: self.gartenLoaded,
          gartenFileLoaded: self.gartenFileLoaded,
          gvLoaded: self.gvLoaded,
          herkunftLoaded: self.herkunftLoaded,
          herkunftFileLoaded: self.herkunftFileLoaded,
          kulturLoaded: self.kulturLoaded,
          kulturFileLoaded: self.kulturFileLoaded,
          kulturOptionLoaded: self.kulturOptionLoaded,
          kulturQkLoaded: self.kulturQkLoaded,
          kulturQkChoosenLoaded: self.kulturQkChoosenLoaded,
          lieferungLoaded: self.lieferungLoaded,
          lieferungFileLoaded: self.lieferungFileLoaded,
          personLoaded: self.personLoaded,
          personFileLoaded: self.personFileLoaded,
          personOptionLoaded: self.personOptionLoaded,
          sammelLieferungLoaded: self.sammelLieferungLoaded,
          sammlungLoaded: self.sammlungLoaded,
          sammlungFileLoaded: self.sammlungFileLoaded,
          teilkulturLoaded: self.teilkulturLoaded,
          teilzaehlungLoaded: self.teilzaehlungLoaded,
          userRoleLoaded: self.userRoleLoaded,
          zaehlungLoaded: self.zaehlungLoaded,
        })
      },
      setAeArtLoaded(val) {
