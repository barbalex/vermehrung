 ...
 */
export const ae_art_min_fieldsModelBase = ModelBase.named('ae_art_min_fields')
  .props({
    __typename: types.optional(
      types.literal('ae_art_min_fields'),
      'ae_art_min_fields',
    ),
...
export const ae_art_min_fieldsModelPrimitives = selectFromae_art_min_fields()
  .changed.name
