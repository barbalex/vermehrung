...
/**
 * LieferungMaxFieldsBase
 * auto generated base class for the model LieferungMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const LieferungMaxFieldsModelBase = ModelBase
  .named('LieferungMaxFields')
  .props({
...
export class LieferungMaxFieldsModelSelector extends QueryBuilder {
