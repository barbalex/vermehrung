...
/**
 * GartenTeilzaehlungSumsMaxFieldsBase
 * auto generated base class for the model GartenTeilzaehlungSumsMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const GartenTeilzaehlungSumsMaxFieldsModelBase = ModelBase
  .named('GartenTeilzaehlungSumsMaxFields')
  .props({
    __typename: types.optional(types.literal("garten_teilzaehlung_sums_max_fields"), "garten_teilzaehlung_sums_max_fields"),
...
export class GartenTeilzaehlungSumsMaxFieldsModelSelector extends QueryBuilder {
