...
/**
 * person_min_fieldsBase
 * auto generated base class for the model person_min_fieldsModel.
 *
 * aggregate min on columns
 */
export const person_min_fieldsModelBase = ModelBase
  .named('person_min_fields')
  .props({
...
export class person_min_fieldsModelSelector extends QueryBuilder {
...
export const person_min_fieldsModelPrimitives = selectFromperson_min_fields()._depth._parent_rev._rev.account_id.adresszusatz.bemerkungen.changed.changed_by.email.name.nr.ort.plz.strasse.telefon_geschaeft.telefon_mobile.telefon_privat.user_role
