...
/**
 * KulturOptionBase
 * auto generated base class for the model KulturOptionModel.
 *
 * columns and relationships of "kultur_option"
 */
export const KulturOptionModelBase = ModelBase
  .named('KulturOption')
  .props({
...
export class KulturOptionModelSelector extends QueryBuilder {
...
export function selectFromKulturOption() {
  return new KulturOptionModelSelector()
}

export const kulturOptionModelPrimitives = selectFromKulturOption()._conflicts._depth._parent_rev._rev._revisions.ev_datum.ev_geplant.ev_person_id.ev_teilkultur_id.kultur_id.tk.tk_bemerkungen.tz_andere_menge.tz_anzahl_mutterpflanzen.tz_auspflanzbereit_beschreibung.tz_bemerkungen.tz_teilkultur_id.z_bemerkungen
