...
/**
 * HerkunftSumsMinFieldsBase
 * auto generated base class for the model HerkunftSumsMinFieldsModel.
 *
 * aggregate min on columns
 */
export const HerkunftSumsMinFieldsModelBase = ModelBase
  .named('HerkunftSumsMinFields')
  .props({
    __typename: types.optional(types.literal("herkunft_sums_min_fields"), "herkunft_sums_min_fields"),
...
export class HerkunftSumsMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftSumsMinFields() {
  return new HerkunftSumsMinFieldsModelSelector()
}

export const herkunftSumsMinFieldsModelPrimitives = selectFromHerkunftSumsMinFields().action.andere_menge.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.art_id.auspflanzbereit_beschreibung.bemerkungen.datum.gramm_samen.herkunft_id.partitioner.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
