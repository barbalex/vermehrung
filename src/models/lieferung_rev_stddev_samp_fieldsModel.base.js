...
export const lieferung_rev_stddev_samp_fieldsModelPrimitives = selectFromlieferung_rev_stddev_samp_fields()._depth.anzahl_auspflanzbereit.anzahl_pflanzen.gramm_samen.von_anzahl_individuen
