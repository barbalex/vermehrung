...
/**
 * art_sums_stddev_pop_fieldsBase
 * auto generated base class for the model art_sums_stddev_pop_fieldsModel.
 */
export const art_sums_stddev_pop_fieldsModelBase = ModelBase
  .named('art_sums_stddev_pop_fields')
  .props({
...
export class art_sums_stddev_pop_fieldsModelSelector extends QueryBuilder {
...
export function selectFromart_sums_stddev_pop_fields() {
  return new art_sums_stddev_pop_fieldsModelSelector()
}

export const art_sums_stddev_pop_fieldsModelPrimitives = selectFromart_sums_stddev_pop_fields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
