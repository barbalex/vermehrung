...
/**
 * herkunft_max_fieldsBase
 * auto generated base class for the model herkunft_max_fieldsModel.
 */
export const herkunft_max_fieldsModelBase = ModelBase
...
export function selectFromherkunft_max_fields() {
  return new herkunft_max_fieldsModelSelector()
}

export const herkunft_max_fieldsModelPrimitives = selectFromherkunft_max_fields()._depth._parent_rev._rev._rev_at.bemerkungen.changed.changed_by.gemeinde.kanton.land.lokalname.lv95_x.lv95_y.nr.wgs84_lat.wgs84_long
