...
/**
 * event_max_fieldsBase
 * auto generated base class for the model event_max_fieldsModel.
 */
export const event_max_fieldsModelBase = ModelBase
  .named('event_max_fields')
  .props({
...
export class event_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromevent_max_fields() {
