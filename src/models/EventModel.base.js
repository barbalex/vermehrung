...
export const eventModelPrimitives = selectFromevent()._conflicts._deleted._depth._parent_rev._rev._rev_at._revisions.beschreibung.changed.changed_by.datum.geplant.kultur_id.person_id.teilkultur_id
