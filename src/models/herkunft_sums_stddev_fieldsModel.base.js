...
export class herkunft_sums_stddev_fieldsModelSelector extends QueryBuilder {
...
export function selectFromherkunft_sums_stddev_fields() {
  return new herkunft_sums_stddev_fieldsModelSelector()
}

export const herkunft_sums_stddev_fieldsModelPrimitives = selectFromherkunft_sums_stddev_fields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
