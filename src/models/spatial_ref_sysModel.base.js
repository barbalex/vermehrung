...
export class spatial_ref_sysModelSelector extends QueryBuilder {
...
export function selectFromspatial_ref_sys() {
  return new spatial_ref_sysModelSelector()
}

export const spatial_ref_sysModelPrimitives = selectFromspatial_ref_sys().auth_name.auth_srid.proj4text.srid.srtext
