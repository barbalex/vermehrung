...
export const herkunft_rev_max_fieldsModelPrimitives = selectFromherkunft_rev_max_fields()._depth._parent_rev._rev.bemerkungen.changed.changed_by.gemeinde.herkunft_id.kanton.land.lokalname.nr
