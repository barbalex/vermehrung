...
/**
 * sammlung_min_fieldsBase
 * auto generated base class for the model sammlung_min_fieldsModel.
 */
export const sammlung_min_fieldsModelBase = ModelBase
  .named('sammlung_min_fields')
  .props({
    __typename: types.optional(types.literal("sammlung_min_fields"), "sammlung_min_fields"),
...
export class sammlung_min_fieldsModelSelector extends QueryBuilder {
...
export function selectFromsammlung_min_fields() {
  return new sammlung_min_fieldsModelSelector()
}

export const sammlung_min_fieldsModelPrimitives = selectFromsammlung_min_fields()._depth._parent_rev._rev._rev_at.andere_menge.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.herkunft_id.lv95_x.lv95_y.nr.person_id.von_anzahl_individuen.wgs84_lat.wgs84_long
