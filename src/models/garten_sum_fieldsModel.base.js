...
/**
 * garten_sum_fieldsBase
 * auto generated base class for the model garten_sum_fieldsModel.
 */
export const garten_sum_fieldsModelBase = ModelBase
  .named('garten_sum_fields')
  .props({
...
export class garten_sum_fieldsModelSelector extends QueryBuilder {
...
export function selectFromgarten_sum_fields() {
  return new garten_sum_fieldsModelSelector()
}

export const garten_sum_fieldsModelPrimitives = selectFromgarten_sum_fields()._depth._rev_at.lv95_x.lv95_y.plz.wgs84_lat.wgs84_long
