...
/**
 * art_sums_max_fieldsBase
 * auto generated base class for the model art_sums_max_fieldsModel.
 *
 * aggregate max on columns
 */
export const art_sums_max_fieldsModelBase = ModelBase
  .named('art_sums_max_fields')
  .props({
...
export class art_sums_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromart_sums_max_fields() {
  return new art_sums_max_fieldsModelSelector()
}

export const art_sums_max_fieldsModelPrimitives = selectFromart_sums_max_fields().action.andere_menge.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.art_id.auspflanzbereit_beschreibung.bemerkungen.datum.gramm_samen.partitioner.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
