 ...
 */
export const query_rootModelBase = ModelBase.named('query_root')
  .props({
    ...
    kultur_qk_choosen_rev_aggregate: types.union(
      types.undefined,
      types.frozen(),
    ),
    ...
    sammel_lieferung_rev_aggregate: types.union(
      types.undefined,
      types.frozen(),
    ),
    ...
    teilzaehlung_aggregate: types.union(
      types.undefined,
