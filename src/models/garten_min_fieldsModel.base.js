...
/**
 * garten_min_fieldsBase
 * auto generated base class for the model garten_min_fieldsModel.
 */
export const garten_min_fieldsModelBase = ModelBase
  .named('garten_min_fields')
  .props({
    __typename: types.optional(types.literal("garten_min_fields"), "garten_min_fields"),
...
export class garten_min_fieldsModelSelector extends QueryBuilder {
...
export function selectFromgarten_min_fields() {
  return new garten_min_fieldsModelSelector()
}

export const garten_min_fieldsModelPrimitives = selectFromgarten_min_fields()._depth._parent_rev._rev._rev_at.bemerkungen.changed.changed_by.lv95_x.lv95_y.name.ort.person_id.plz.strasse.wgs84_lat.wgs84_long
