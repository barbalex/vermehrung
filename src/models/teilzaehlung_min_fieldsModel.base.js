...
/**
 * teilzaehlung_min_fieldsBase
 * auto generated base class for the model teilzaehlung_min_fieldsModel.
 *
 * aggregate min on columns
 */
export const teilzaehlung_min_fieldsModelBase = ModelBase
  .named('teilzaehlung_min_fields')
  .props({
...
export class teilzaehlung_min_fieldsModelSelector extends QueryBuilder {
...
export function selectFromteilzaehlung_min_fields() {
