 ...
 */
export const person_optionModelBase = ModelBase.named('person_option')
  .props({
...
export const person_optionModelPrimitives = selectFromperson_option()._conflicts
  ...
  .ku_zwischenlager.li_show_sl.li_show_sl_felder.sl_auto_copy_edits
