...
export const RootStoreBase = MSTGQLStore
  ...
  .props({
    ...
    art_sumss: types.optional(types.map(types.late(() => art_sumsModel)), {}),
    ...
    garten_teilzaehlung_sumss: types.optional(types.map(types.late(() => garten_teilzaehlung_sumsModel)), {}),
    ...
    herkunft_sumss: types.optional(types.map(types.late(() => herkunft_sumsModel)), {}),
