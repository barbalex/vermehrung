...
export const lieferung_file_min_fieldsModelPrimitives = selectFromlieferung_file_min_fields()._rev_at.beschreibung.changed.file_id.file_mime_type.lieferung_id.name
