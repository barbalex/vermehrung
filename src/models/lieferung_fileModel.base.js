 ...
 */
export const lieferung_fileModelBase = ModelBase
  .named('lieferung_file')
  .props({
...
export const lieferung_fileModelPrimitives = selectFromlieferung_file()._rev_at.beschreibung.changed.file_id.file_mime_type.lieferung_id.name
