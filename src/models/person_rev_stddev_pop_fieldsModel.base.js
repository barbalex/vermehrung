...
export class person_rev_stddev_pop_fieldsModelSelector extends QueryBuilder {
  get _depth() { return this.__attr(`_depth`) }
  get _rev_at() { return this.__attr(`_rev_at`) }
  get plz() { return this.__attr(`plz`) }
}
export function selectFromperson_rev_stddev_pop_fields() {
  return new person_rev_stddev_pop_fieldsModelSelector()
}

export const person_rev_stddev_pop_fieldsModelPrimitives = selectFromperson_rev_stddev_pop_fields()._depth._rev_at.plz
