...
export const art_qk_choosen_rev_max_fieldsModelPrimitives = selectFromart_qk_choosen_rev_max_fields()._depth._parent_rev._rev._rev_at.art_id.art_qk_choosen_id.changed.changed_by.qk_id.qk_name
