...
/**
 * SammelLieferungRevBase
 * auto generated base class for the model SammelLieferungRevModel.
 *
 * columns and relationships of "sammel_lieferung_rev"
 */
export const SammelLieferungRevModelBase = ModelBase
  .named('SammelLieferungRev')
  .props({
...
export class SammelLieferungRevModelSelector extends QueryBuilder {
...
export function selectFromSammelLieferungRev() {
  return new SammelLieferungRevModelSelector()
}

export const sammelLieferungRevModelPrimitives = selectFromSammelLieferungRev()._deleted._depth._parent_rev._rev._revisions.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.datum.geplant.gramm_samen.nach_ausgepflanzt.nach_kultur_id.person_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
