...
/**
 * LieferungRevMinFieldsBase
 * auto generated base class for the model LieferungRevMinFieldsModel.
 *
 * aggregate min on columns
 */
export const LieferungRevMinFieldsModelBase = ModelBase
  .named('LieferungRevMinFields')
  .props({
    __typename: types.optional(types.literal("lieferung_rev_min_fields"), "lieferung_rev_min_fields"),
...
export class LieferungRevMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromLieferungRevMinFields() {
  return new LieferungRevMinFieldsModelSelector()
}

export const lieferungRevMinFieldsModelPrimitives = selectFromLieferungRevMinFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.nach_kultur_id.person_id.sammel_lieferung_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
