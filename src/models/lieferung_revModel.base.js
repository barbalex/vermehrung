...
export const lieferung_revModelPrimitives = selectFromlieferung_rev()._deleted
  ._depth._parent_rev._rev._rev_at._revisions.andere_menge
  .anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by
  .datum.geplant.gramm_samen.lieferung_id.nach_ausgepflanzt.nach_kultur_id
  .person_id.sammel_lieferung_id.von_anzahl_individuen.von_kultur_id
  .von_sammlung_id
