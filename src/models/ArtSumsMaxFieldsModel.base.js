...
/**
 * ArtSumsMaxFieldsBase
 * auto generated base class for the model ArtSumsMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const ArtSumsMaxFieldsModelBase = ModelBase
  .named('ArtSumsMaxFields')
  .props({
    __typename: types.optional(types.literal("art_sums_max_fields"), "art_sums_max_fields"),
...
export class ArtSumsMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromArtSumsMaxFields() {
  return new ArtSumsMaxFieldsModelSelector()
}

export const artSumsMaxFieldsModelPrimitives = selectFromArtSumsMaxFields().action.andere_menge.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.art_id.auspflanzbereit_beschreibung.bemerkungen.datum.gramm_samen.partitioner.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
