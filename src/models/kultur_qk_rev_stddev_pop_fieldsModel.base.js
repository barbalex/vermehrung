...
/**
 * kultur_qk_rev_stddev_pop_fieldsBase
 * auto generated base class for the model kultur_qk_rev_stddev_pop_fieldsModel.
 */
export const kultur_qk_rev_stddev_pop_fieldsModelBase = ModelBase
  .named('kultur_qk_rev_stddev_pop_fields')
  .props({
