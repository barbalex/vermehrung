...
export class lieferung_rev_variance_fieldsModelSelector extends QueryBuilder {
...
export function selectFromlieferung_rev_variance_fields() {
  return new lieferung_rev_variance_fieldsModelSelector()
}

export const lieferung_rev_variance_fieldsModelPrimitives = selectFromlieferung_rev_variance_fields()._depth._rev_at.anzahl_auspflanzbereit.anzahl_pflanzen.gramm_samen.von_anzahl_individuen
