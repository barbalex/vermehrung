...
import { art_file_avg_fieldsModel } from "./art_file_avg_fieldsModel"
import { art_file_avg_fieldsModelPrimitives, art_file_avg_fieldsModelSelector } from "./art_file_avg_fieldsModel.base"
...
import { art_file_stddev_fieldsModel } from "./art_file_stddev_fieldsModel"
import { art_file_stddev_fieldsModelPrimitives, art_file_stddev_fieldsModelSelector } from "./art_file_stddev_fieldsModel.base"
import { art_file_stddev_pop_fieldsModel } from "./art_file_stddev_pop_fieldsModel"
import { art_file_stddev_pop_fieldsModelPrimitives, art_file_stddev_pop_fieldsModelSelector } from "./art_file_stddev_pop_fieldsModel.base"
import { art_file_stddev_samp_fieldsModel } from "./art_file_stddev_samp_fieldsModel"
import { art_file_stddev_samp_fieldsModelPrimitives, art_file_stddev_samp_fieldsModelSelector } from "./art_file_stddev_samp_fieldsModel.base"
import { art_file_sum_fieldsModel } from "./art_file_sum_fieldsModel"
import { art_file_sum_fieldsModelPrimitives, art_file_sum_fieldsModelSelector } from "./art_file_sum_fieldsModel.base"
import { art_file_var_pop_fieldsModel } from "./art_file_var_pop_fieldsModel"
import { art_file_var_pop_fieldsModelPrimitives, art_file_var_pop_fieldsModelSelector } from "./art_file_var_pop_fieldsModel.base"
import { art_file_var_samp_fieldsModel } from "./art_file_var_samp_fieldsModel"
import { art_file_var_samp_fieldsModelPrimitives, art_file_var_samp_fieldsModelSelector } from "./art_file_var_samp_fieldsModel.base"
import { art_file_variance_fieldsModel } from "./art_file_variance_fieldsModel"
import { art_file_variance_fieldsModelPrimitives, art_file_variance_fieldsModelSelector } from "./art_file_variance_fieldsModel.base"
...
import { garten_file_avg_fieldsModel } from "./garten_file_avg_fieldsModel"
import { garten_file_avg_fieldsModelPrimitives, garten_file_avg_fieldsModelSelector } from "./garten_file_avg_fieldsModel.base"
...
import { garten_file_stddev_fieldsModel } from "./garten_file_stddev_fieldsModel"
import { garten_file_stddev_fieldsModelPrimitives, garten_file_stddev_fieldsModelSelector } from "./garten_file_stddev_fieldsModel.base"
import { garten_file_stddev_pop_fieldsModel } from "./garten_file_stddev_pop_fieldsModel"
import { garten_file_stddev_pop_fieldsModelPrimitives, garten_file_stddev_pop_fieldsModelSelector } from "./garten_file_stddev_pop_fieldsModel.base"
import { garten_file_stddev_samp_fieldsModel } from "./garten_file_stddev_samp_fieldsModel"
import { garten_file_stddev_samp_fieldsModelPrimitives, garten_file_stddev_samp_fieldsModelSelector } from "./garten_file_stddev_samp_fieldsModel.base"
import { garten_file_sum_fieldsModel } from "./garten_file_sum_fieldsModel"
import { garten_file_sum_fieldsModelPrimitives, garten_file_sum_fieldsModelSelector } from "./garten_file_sum_fieldsModel.base"
import { garten_file_var_pop_fieldsModel } from "./garten_file_var_pop_fieldsModel"
import { garten_file_var_pop_fieldsModelPrimitives, garten_file_var_pop_fieldsModelSelector } from "./garten_file_var_pop_fieldsModel.base"
import { garten_file_var_samp_fieldsModel } from "./garten_file_var_samp_fieldsModel"
import { garten_file_var_samp_fieldsModelPrimitives, garten_file_var_samp_fieldsModelSelector } from "./garten_file_var_samp_fieldsModel.base"
import { garten_file_variance_fieldsModel } from "./garten_file_variance_fieldsModel"
import { garten_file_variance_fieldsModelPrimitives, garten_file_variance_fieldsModelSelector } from "./garten_file_variance_fieldsModel.base"
...
import { herkunft_file_avg_fieldsModel } from "./herkunft_file_avg_fieldsModel"
import { herkunft_file_avg_fieldsModelPrimitives, herkunft_file_avg_fieldsModelSelector } from "./herkunft_file_avg_fieldsModel.base"
...
import { herkunft_file_stddev_fieldsModel } from "./herkunft_file_stddev_fieldsModel"
import { herkunft_file_stddev_fieldsModelPrimitives, herkunft_file_stddev_fieldsModelSelector } from "./herkunft_file_stddev_fieldsModel.base"
import { herkunft_file_stddev_pop_fieldsModel } from "./herkunft_file_stddev_pop_fieldsModel"
import { herkunft_file_stddev_pop_fieldsModelPrimitives, herkunft_file_stddev_pop_fieldsModelSelector } from "./herkunft_file_stddev_pop_fieldsModel.base"
import { herkunft_file_stddev_samp_fieldsModel } from "./herkunft_file_stddev_samp_fieldsModel"
import { herkunft_file_stddev_samp_fieldsModelPrimitives, herkunft_file_stddev_samp_fieldsModelSelector } from "./herkunft_file_stddev_samp_fieldsModel.base"
import { herkunft_file_sum_fieldsModel } from "./herkunft_file_sum_fieldsModel"
import { herkunft_file_sum_fieldsModelPrimitives, herkunft_file_sum_fieldsModelSelector } from "./herkunft_file_sum_fieldsModel.base"
import { herkunft_file_var_pop_fieldsModel } from "./herkunft_file_var_pop_fieldsModel"
import { herkunft_file_var_pop_fieldsModelPrimitives, herkunft_file_var_pop_fieldsModelSelector } from "./herkunft_file_var_pop_fieldsModel.base"
import { herkunft_file_var_samp_fieldsModel } from "./herkunft_file_var_samp_fieldsModel"
import { herkunft_file_var_samp_fieldsModelPrimitives, herkunft_file_var_samp_fieldsModelSelector } from "./herkunft_file_var_samp_fieldsModel.base"
import { herkunft_file_variance_fieldsModel } from "./herkunft_file_variance_fieldsModel"
import { herkunft_file_variance_fieldsModelPrimitives, herkunft_file_variance_fieldsModelSelector } from "./herkunft_file_variance_fieldsModel.base"
...
import { lieferung_file_avg_fieldsModel } from "./lieferung_file_avg_fieldsModel"
import { lieferung_file_avg_fieldsModelPrimitives, lieferung_file_avg_fieldsModelSelector } from "./lieferung_file_avg_fieldsModel.base"
...
import { lieferung_file_stddev_fieldsModel } from "./lieferung_file_stddev_fieldsModel"
import { lieferung_file_stddev_fieldsModelPrimitives, lieferung_file_stddev_fieldsModelSelector } from "./lieferung_file_stddev_fieldsModel.base"
import { lieferung_file_stddev_pop_fieldsModel } from "./lieferung_file_stddev_pop_fieldsModel"
import { lieferung_file_stddev_pop_fieldsModelPrimitives, lieferung_file_stddev_pop_fieldsModelSelector } from "./lieferung_file_stddev_pop_fieldsModel.base"
import { lieferung_file_stddev_samp_fieldsModel } from "./lieferung_file_stddev_samp_fieldsModel"
import { lieferung_file_stddev_samp_fieldsModelPrimitives, lieferung_file_stddev_samp_fieldsModelSelector } from "./lieferung_file_stddev_samp_fieldsModel.base"
import { lieferung_file_sum_fieldsModel } from "./lieferung_file_sum_fieldsModel"
import { lieferung_file_sum_fieldsModelPrimitives, lieferung_file_sum_fieldsModelSelector } from "./lieferung_file_sum_fieldsModel.base"
import { lieferung_file_var_pop_fieldsModel } from "./lieferung_file_var_pop_fieldsModel"
import { lieferung_file_var_pop_fieldsModelPrimitives, lieferung_file_var_pop_fieldsModelSelector } from "./lieferung_file_var_pop_fieldsModel.base"
import { lieferung_file_var_samp_fieldsModel } from "./lieferung_file_var_samp_fieldsModel"
import { lieferung_file_var_samp_fieldsModelPrimitives, lieferung_file_var_samp_fieldsModelSelector } from "./lieferung_file_var_samp_fieldsModel.base"
import { lieferung_file_variance_fieldsModel } from "./lieferung_file_variance_fieldsModel"
import { lieferung_file_variance_fieldsModelPrimitives, lieferung_file_variance_fieldsModelSelector } from "./lieferung_file_variance_fieldsModel.base"
...
import { sammlung_file_avg_fieldsModel } from "./sammlung_file_avg_fieldsModel"
import { sammlung_file_avg_fieldsModelPrimitives, sammlung_file_avg_fieldsModelSelector } from "./sammlung_file_avg_fieldsModel.base"
...
import { sammlung_file_stddev_fieldsModel } from "./sammlung_file_stddev_fieldsModel"
import { sammlung_file_stddev_fieldsModelPrimitives, sammlung_file_stddev_fieldsModelSelector } from "./sammlung_file_stddev_fieldsModel.base"
import { sammlung_file_stddev_pop_fieldsModel } from "./sammlung_file_stddev_pop_fieldsModel"
import { sammlung_file_stddev_pop_fieldsModelPrimitives, sammlung_file_stddev_pop_fieldsModelSelector } from "./sammlung_file_stddev_pop_fieldsModel.base"
import { sammlung_file_stddev_samp_fieldsModel } from "./sammlung_file_stddev_samp_fieldsModel"
import { sammlung_file_stddev_samp_fieldsModelPrimitives, sammlung_file_stddev_samp_fieldsModelSelector } from "./sammlung_file_stddev_samp_fieldsModel.base"
import { sammlung_file_sum_fieldsModel } from "./sammlung_file_sum_fieldsModel"
import { sammlung_file_sum_fieldsModelPrimitives, sammlung_file_sum_fieldsModelSelector } from "./sammlung_file_sum_fieldsModel.base"
import { sammlung_file_var_pop_fieldsModel } from "./sammlung_file_var_pop_fieldsModel"
import { sammlung_file_var_pop_fieldsModelPrimitives, sammlung_file_var_pop_fieldsModelSelector } from "./sammlung_file_var_pop_fieldsModel.base"
import { sammlung_file_var_samp_fieldsModel } from "./sammlung_file_var_samp_fieldsModel"
import { sammlung_file_var_samp_fieldsModelPrimitives, sammlung_file_var_samp_fieldsModelSelector } from "./sammlung_file_var_samp_fieldsModel.base"
import { sammlung_file_variance_fieldsModel } from "./sammlung_file_variance_fieldsModel"
import { sammlung_file_variance_fieldsModelPrimitives, sammlung_file_variance_fieldsModelSelector } from "./sammlung_file_variance_fieldsModel.base"
...
import { kultur_file_avg_fieldsModel } from "./kultur_file_avg_fieldsModel"
import { kultur_file_avg_fieldsModelPrimitives, kultur_file_avg_fieldsModelSelector } from "./kultur_file_avg_fieldsModel.base"
...
import { kultur_file_stddev_fieldsModel } from "./kultur_file_stddev_fieldsModel"
import { kultur_file_stddev_fieldsModelPrimitives, kultur_file_stddev_fieldsModelSelector } from "./kultur_file_stddev_fieldsModel.base"
import { kultur_file_stddev_pop_fieldsModel } from "./kultur_file_stddev_pop_fieldsModel"
import { kultur_file_stddev_pop_fieldsModelPrimitives, kultur_file_stddev_pop_fieldsModelSelector } from "./kultur_file_stddev_pop_fieldsModel.base"
import { kultur_file_stddev_samp_fieldsModel } from "./kultur_file_stddev_samp_fieldsModel"
import { kultur_file_stddev_samp_fieldsModelPrimitives, kultur_file_stddev_samp_fieldsModelSelector } from "./kultur_file_stddev_samp_fieldsModel.base"
import { kultur_file_sum_fieldsModel } from "./kultur_file_sum_fieldsModel"
import { kultur_file_sum_fieldsModelPrimitives, kultur_file_sum_fieldsModelSelector } from "./kultur_file_sum_fieldsModel.base"
import { kultur_file_var_pop_fieldsModel } from "./kultur_file_var_pop_fieldsModel"
import { kultur_file_var_pop_fieldsModelPrimitives, kultur_file_var_pop_fieldsModelSelector } from "./kultur_file_var_pop_fieldsModel.base"
import { kultur_file_var_samp_fieldsModel } from "./kultur_file_var_samp_fieldsModel"
import { kultur_file_var_samp_fieldsModelPrimitives, kultur_file_var_samp_fieldsModelSelector } from "./kultur_file_var_samp_fieldsModel.base"
import { kultur_file_variance_fieldsModel } from "./kultur_file_variance_fieldsModel"
import { kultur_file_variance_fieldsModelPrimitives, kultur_file_variance_fieldsModelSelector } from "./kultur_file_variance_fieldsModel.base"
...
import { person_file_avg_fieldsModel } from "./person_file_avg_fieldsModel"
import { person_file_avg_fieldsModelPrimitives, person_file_avg_fieldsModelSelector } from "./person_file_avg_fieldsModel.base"
...
import { person_file_stddev_fieldsModel } from "./person_file_stddev_fieldsModel"
import { person_file_stddev_fieldsModelPrimitives, person_file_stddev_fieldsModelSelector } from "./person_file_stddev_fieldsModel.base"
import { person_file_stddev_pop_fieldsModel } from "./person_file_stddev_pop_fieldsModel"
import { person_file_stddev_pop_fieldsModelPrimitives, person_file_stddev_pop_fieldsModelSelector } from "./person_file_stddev_pop_fieldsModel.base"
import { person_file_stddev_samp_fieldsModel } from "./person_file_stddev_samp_fieldsModel"
import { person_file_stddev_samp_fieldsModelPrimitives, person_file_stddev_samp_fieldsModelSelector } from "./person_file_stddev_samp_fieldsModel.base"
import { person_file_sum_fieldsModel } from "./person_file_sum_fieldsModel"
import { person_file_sum_fieldsModelPrimitives, person_file_sum_fieldsModelSelector } from "./person_file_sum_fieldsModel.base"
import { person_file_var_pop_fieldsModel } from "./person_file_var_pop_fieldsModel"
import { person_file_var_pop_fieldsModelPrimitives, person_file_var_pop_fieldsModelSelector } from "./person_file_var_pop_fieldsModel.base"
import { person_file_var_samp_fieldsModel } from "./person_file_var_samp_fieldsModel"
import { person_file_var_samp_fieldsModelPrimitives, person_file_var_samp_fieldsModelSelector } from "./person_file_var_samp_fieldsModel.base"
import { person_file_variance_fieldsModel } from "./person_file_variance_fieldsModel"
import { person_file_variance_fieldsModelPrimitives, person_file_variance_fieldsModelSelector } from "./person_file_variance_fieldsModel.base"
...
import { ae_art_avg_fieldsModel } from "./ae_art_avg_fieldsModel"
import { ae_art_avg_fieldsModelPrimitives, ae_art_avg_fieldsModelSelector } from "./ae_art_avg_fieldsModel.base"
...
import { ae_art_stddev_fieldsModel } from "./ae_art_stddev_fieldsModel"
import { ae_art_stddev_fieldsModelPrimitives, ae_art_stddev_fieldsModelSelector } from "./ae_art_stddev_fieldsModel.base"
import { ae_art_stddev_pop_fieldsModel } from "./ae_art_stddev_pop_fieldsModel"
import { ae_art_stddev_pop_fieldsModelPrimitives, ae_art_stddev_pop_fieldsModelSelector } from "./ae_art_stddev_pop_fieldsModel.base"
import { ae_art_stddev_samp_fieldsModel } from "./ae_art_stddev_samp_fieldsModel"
import { ae_art_stddev_samp_fieldsModelPrimitives, ae_art_stddev_samp_fieldsModelSelector } from "./ae_art_stddev_samp_fieldsModel.base"
import { ae_art_sum_fieldsModel } from "./ae_art_sum_fieldsModel"
import { ae_art_sum_fieldsModelPrimitives, ae_art_sum_fieldsModelSelector } from "./ae_art_sum_fieldsModel.base"
import { ae_art_var_pop_fieldsModel } from "./ae_art_var_pop_fieldsModel"
import { ae_art_var_pop_fieldsModelPrimitives, ae_art_var_pop_fieldsModelSelector } from "./ae_art_var_pop_fieldsModel.base"
import { ae_art_var_samp_fieldsModel } from "./ae_art_var_samp_fieldsModel"
import { ae_art_var_samp_fieldsModelPrimitives, ae_art_var_samp_fieldsModelSelector } from "./ae_art_var_samp_fieldsModel.base"
import { ae_art_variance_fieldsModel } from "./ae_art_variance_fieldsModel"
import { ae_art_variance_fieldsModelPrimitives, ae_art_variance_fieldsModelSelector } from "./ae_art_variance_fieldsModel.base"
...
export const RootStoreBase = MSTGQLStore
  ...
  .actions(self => ({
    ...
    queryAe_art_by_pk(variables, resultSelector = ae_artModelPrimitives.toString(), options = {}) {
      return self.query(`query ae_art_by_pk($id: ID!) { ae_art_by_pk(id: $id) {
        ${typeof resultSelector === "function" ? resultSelector(new ae_artModelSelector()).toString() : resultSelector}
      } }`, variables, options)
    },
    ...
    queryKultur_qk_by_pk(variables, resultSelector = kultur_qkModelPrimitives.toString(), options = {}) {
      return self.query(`query kultur_qk_by_pk($id: ID!) { kultur_qk_by_pk(id: $id) {
        ${typeof resultSelector === "function" ? resultSelector(new kultur_qkModelSelector()).toString() : resultSelector}
      } }`, variables, options)
    },
    ...
    mutateDelete_ae_art_by_pk(variables, resultSelector = ae_artModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation delete_ae_art_by_pk($id: ID!) { delete_ae_art_by_pk(id: $id) {
        ${typeof resultSelector === "function" ? resultSelector(new ae_artModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateDelete_kultur_qk_by_pk(variables, resultSelector = kultur_qkModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation delete_kultur_qk_by_pk($id: ID!) { delete_kultur_qk_by_pk(id: $id) {
        ${typeof resultSelector === "function" ? resultSelector(new kultur_qkModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateInsert_ae_art(variables, resultSelector = ae_art_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation insert_ae_art($objects: [ae_art_insert_input!]!, $on_conflict: ae_art_on_conflict) { insert_ae_art(objects: $objects, on_conflict: $on_conflict) {
        ${typeof resultSelector === "function" ? resultSelector(new ae_art_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateInsert_ae_art_one(variables, resultSelector = ae_artModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation insert_ae_art_one($object: ae_art_insert_input!, $on_conflict: ae_art_on_conflict) { insert_ae_art_one(object: $object, on_conflict: $on_conflict) {
        ${typeof resultSelector === "function" ? resultSelector(new ae_artModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateUpdate_ae_art(variables, resultSelector = ae_art_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_ae_art($_inc: ae_art_inc_input, $_set: ae_art_set_input, $where: ae_art_bool_exp!) { update_ae_art(_inc: $_inc, _set: $_set, where: $where) {
        ${typeof resultSelector === "function" ? resultSelector(new ae_art_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateUpdate_ae_art_by_pk(variables, resultSelector = ae_artModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_ae_art_by_pk($_inc: ae_art_inc_input, $_set: ae_art_set_input, $pk_columns: ae_art_pk_columns_input!) { update_ae_art_by_pk(_inc: $_inc, _set: $_set, pk_columns: $pk_columns) {
        ${typeof resultSelector === "function" ? resultSelector(new ae_artModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateUpdate_art_file(variables, resultSelector = art_file_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_art_file($_inc: art_file_inc_input, $_set: art_file_set_input, $where: art_file_bool_exp!) { update_art_file(_inc: $_inc, _set: $_set, where: $where) {
        ${typeof resultSelector === "function" ? resultSelector(new art_file_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateUpdate_art_file_by_pk(variables, resultSelector = art_fileModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_art_file_by_pk($_inc: art_file_inc_input, $_set: art_file_set_input, $pk_columns: art_file_pk_columns_input!) { update_art_file_by_pk(_inc: $_inc, _set: $_set, pk_columns: $pk_columns) {
        ${typeof resultSelector === "function" ? resultSelector(new art_fileModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateUpdate_garten_file(variables, resultSelector = garten_file_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_garten_file($_inc: garten_file_inc_input, $_set: garten_file_set_input, $where: garten_file_bool_exp!) { update_garten_file(_inc: $_inc, _set: $_set, where: $where) {
        ${typeof resultSelector === "function" ? resultSelector(new garten_file_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateUpdate_garten_file_by_pk(variables, resultSelector = garten_fileModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_garten_file_by_pk($_inc: garten_file_inc_input, $_set: garten_file_set_input, $pk_columns: garten_file_pk_columns_input!) { update_garten_file_by_pk(_inc: $_inc, _set: $_set, pk_columns: $pk_columns) {
        ${typeof resultSelector === "function" ? resultSelector(new garten_fileModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateUpdate_herkunft_file(variables, resultSelector = herkunft_file_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_herkunft_file($_inc: herkunft_file_inc_input, $_set: herkunft_file_set_input, $where: herkunft_file_bool_exp!) { update_herkunft_file(_inc: $_inc, _set: $_set, where: $where) {
        ${typeof resultSelector === "function" ? resultSelector(new herkunft_file_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateUpdate_herkunft_file_by_pk(variables, resultSelector = herkunft_fileModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_herkunft_file_by_pk($_inc: herkunft_file_inc_input, $_set: herkunft_file_set_input, $pk_columns: herkunft_file_pk_columns_input!) { update_herkunft_file_by_pk(_inc: $_inc, _set: $_set, pk_columns: $pk_columns) {
        ${typeof resultSelector === "function" ? resultSelector(new herkunft_fileModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateUpdate_kultur_file(variables, resultSelector = kultur_file_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_kultur_file($_inc: kultur_file_inc_input, $_set: kultur_file_set_input, $where: kultur_file_bool_exp!) { update_kultur_file(_inc: $_inc, _set: $_set, where: $where) {
        ${typeof resultSelector === "function" ? resultSelector(new kultur_file_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateUpdate_kultur_file_by_pk(variables, resultSelector = kultur_fileModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_kultur_file_by_pk($_inc: kultur_file_inc_input, $_set: kultur_file_set_input, $pk_columns: kultur_file_pk_columns_input!) { update_kultur_file_by_pk(_inc: $_inc, _set: $_set, pk_columns: $pk_columns) {
        ${typeof resultSelector === "function" ? resultSelector(new kultur_fileModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateUpdate_lieferung_file(variables, resultSelector = lieferung_file_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_lieferung_file($_inc: lieferung_file_inc_input, $_set: lieferung_file_set_input, $where: lieferung_file_bool_exp!) { update_lieferung_file(_inc: $_inc, _set: $_set, where: $where) {
        ${typeof resultSelector === "function" ? resultSelector(new lieferung_file_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateUpdate_lieferung_file_by_pk(variables, resultSelector = lieferung_fileModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_lieferung_file_by_pk($_inc: lieferung_file_inc_input, $_set: lieferung_file_set_input, $pk_columns: lieferung_file_pk_columns_input!) { update_lieferung_file_by_pk(_inc: $_inc, _set: $_set, pk_columns: $pk_columns) {
        ${typeof resultSelector === "function" ? resultSelector(new lieferung_fileModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateUpdate_person_file(variables, resultSelector = person_file_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_person_file($_inc: person_file_inc_input, $_set: person_file_set_input, $where: person_file_bool_exp!) { update_person_file(_inc: $_inc, _set: $_set, where: $where) {
        ${typeof resultSelector === "function" ? resultSelector(new person_file_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateUpdate_person_file_by_pk(variables, resultSelector = person_fileModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_person_file_by_pk($_inc: person_file_inc_input, $_set: person_file_set_input, $pk_columns: person_file_pk_columns_input!) { update_person_file_by_pk(_inc: $_inc, _set: $_set, pk_columns: $pk_columns) {
        ${typeof resultSelector === "function" ? resultSelector(new person_fileModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateUpdate_sammlung_file(variables, resultSelector = sammlung_file_mutation_responseModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_sammlung_file($_inc: sammlung_file_inc_input, $_set: sammlung_file_set_input, $where: sammlung_file_bool_exp!) { update_sammlung_file(_inc: $_inc, _set: $_set, where: $where) {
        ${typeof resultSelector === "function" ? resultSelector(new sammlung_file_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateUpdate_sammlung_file_by_pk(variables, resultSelector = sammlung_fileModelPrimitives.toString(), optimisticUpdate) {
      return self.mutate(`mutation update_sammlung_file_by_pk($_inc: sammlung_file_inc_input, $_set: sammlung_file_set_input, $pk_columns: sammlung_file_pk_columns_input!) { update_sammlung_file_by_pk(_inc: $_inc, _set: $_set, pk_columns: $pk_columns) {
        ${typeof resultSelector === "function" ? resultSelector(new sammlung_fileModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    subscribeAe_art_by_pk(variables, resultSelector = ae_artModelPrimitives.toString(), onData, onError) {
      return self.subscribe(`subscription ae_art_by_pk($id: ID!) { ae_art_by_pk(id: $id) {
        ${typeof resultSelector === "function" ? resultSelector(new ae_artModelSelector()).toString() : resultSelector}
      } }`, variables, onData, onError)
    },
    ...
    subscribeKultur_qk_by_pk(variables, resultSelector = kultur_qkModelPrimitives.toString(), onData, onError) {
      return self.subscribe(`subscription kultur_qk_by_pk($id: ID!) { kultur_qk_by_pk(id: $id) {
        ${typeof resultSelector === "function" ? resultSelector(new kultur_qkModelSelector()).toString() : resultSelector}
      } }`, variables, onData, onError)
    },
