...
export class art_rev_variance_fieldsModelSelector extends QueryBuilder {
  get _depth() { return this.__attr(`_depth`) }
  get _rev_at() { return this.__attr(`_rev_at`) }
}
export function selectFromart_rev_variance_fields() {
  return new art_rev_variance_fieldsModelSelector()
}

export const art_rev_variance_fieldsModelPrimitives = selectFromart_rev_variance_fields()._depth._rev_at
