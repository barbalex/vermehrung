...
export const event_rev_min_fieldsModelPrimitives = selectFromevent_rev_min_fields()._depth._parent_rev._rev.beschreibung.changed.changed_by.datum.event_id.kultur_id.person_id.teilkultur_id
