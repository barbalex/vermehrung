...
/**
 * LieferungRevMaxFieldsBase
 * auto generated base class for the model LieferungRevMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const LieferungRevMaxFieldsModelBase = ModelBase
  .named('LieferungRevMaxFields')
  .props({
    __typename: types.optional(types.literal("lieferung_rev_max_fields"), "lieferung_rev_max_fields"),
...
export class LieferungRevMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromLieferungRevMaxFields() {
  return new LieferungRevMaxFieldsModelSelector()
}

export const lieferungRevMaxFieldsModelPrimitives = selectFromLieferungRevMaxFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.nach_kultur_id.person_id.sammel_lieferung_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
