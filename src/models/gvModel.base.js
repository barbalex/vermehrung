 ...
 */
export const gvModelBase = ModelBase.named('gv')
  .props({
...
export const gvModelPrimitives = selectFromgv()._conflicts._deleted._depth
  ._parent_rev._rev._rev_at._revisions.changed.changed_by.garten_id.person_id
