...
/**
 * HerkunftSumsVarPopFieldsBase
 * auto generated base class for the model HerkunftSumsVarPopFieldsModel.
 *
 * aggregate var_pop on columns
 */
export const HerkunftSumsVarPopFieldsModelBase = ModelBase
  .named('HerkunftSumsVarPopFields')
  .props({
...
export class HerkunftSumsVarPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftSumsVarPopFields() {
  return new HerkunftSumsVarPopFieldsModelSelector()
}

export const herkunftSumsVarPopFieldsModelPrimitives = selectFromHerkunftSumsVarPopFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
