...
/**
 * SammlungVarSampFieldsBase
 * auto generated base class for the model SammlungVarSampFieldsModel.
 *
 * aggregate var_samp on columns
 */
export const SammlungVarSampFieldsModelBase = ModelBase
  .named('SammlungVarSampFields')
  .props({
...
export class SammlungVarSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammlungVarSampFields() {
  return new SammlungVarSampFieldsModelSelector()
}

export const sammlungVarSampFieldsModelPrimitives = selectFromSammlungVarSampFields()._depth.anzahl_pflanzen.gramm_samen.lv95_x.lv95_y.von_anzahl_individuen.wgs84_lat.wgs84_long
