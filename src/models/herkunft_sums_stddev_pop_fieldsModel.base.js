...
/**
 * herkunft_sums_stddev_pop_fieldsBase
 * auto generated base class for the model herkunft_sums_stddev_pop_fieldsModel.
 */
export const herkunft_sums_stddev_pop_fieldsModelBase = ModelBase
  .named('herkunft_sums_stddev_pop_fields')
  .props({
...
export class herkunft_sums_stddev_pop_fieldsModelSelector extends QueryBuilder {
...
export function selectFromherkunft_sums_stddev_pop_fields() {
  return new herkunft_sums_stddev_pop_fieldsModelSelector()
}

export const herkunft_sums_stddev_pop_fieldsModelPrimitives = selectFromherkunft_sums_stddev_pop_fields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
