...
export const zaehlung_rev_min_fieldsModelPrimitives = selectFromzaehlung_rev_min_fields()._depth._parent_rev._rev.bemerkungen.changed.changed_by.datum.kultur_id
