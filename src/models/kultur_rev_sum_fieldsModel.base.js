...
/**
 * kultur_rev_sum_fieldsBase
 * auto generated base class for the model kultur_rev_sum_fieldsModel.
 */
export const kultur_rev_sum_fieldsModelBase = ModelBase
  .named('kultur_rev_sum_fields')
  .props({
