...
export const art_qk_choosen_max_fieldsModelPrimitives = selectFromart_qk_choosen_max_fields()._depth._parent_rev._rev._rev_at.art_id.changed.changed_by.qk_id
