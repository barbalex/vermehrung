...
export const recreatePersistedStore = async (store) => {
  ...
  const blacklist = [
    ...
    'ae_art_initially_queried_count',
    'art_initially_queried_count',
    'art_file_initially_queried_count',
    'art_qk_initially_queried_count',
    'av_initially_queried_count',
    'event_initially_queried_count',
    'garten_initially_queried_count',
    'garten_file_initially_queried_count',
    'gv_initially_queried_count',
    'herkunft_initially_queried_count',
    'herkunft_file_initially_queried_count',
    'kultur_initially_queried_count',
    'kultur_file_initially_queried_count',
    'kultur_option_initially_queried_count',
    'kultur_qk_initially_queried_count',
    'lieferung_initially_queried_count',
    'lieferung_file_initially_queried_count',
    'person_initially_queried_count',
    'person_file_initially_queried_count',
    'person_option_initially_queried_count',
    'sammel_lieferung_initially_queried_count',
    'sammlung_initially_queried_count',
    'sammlung_file_initially_queried_count',
    'teilkultur_initially_queried_count',
    'teilzaehlung_initially_queried_count',
    'user_role_initially_queried_count',
    'zaehlung_initially_queried_count',
  ]
