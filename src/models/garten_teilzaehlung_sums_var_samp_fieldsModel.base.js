...
/**
 * garten_teilzaehlung_sums_var_samp_fieldsBase
 * auto generated base class for the model garten_teilzaehlung_sums_var_samp_fieldsModel.
 */
export const garten_teilzaehlung_sums_var_samp_fieldsModelBase = ModelBase
  .named('garten_teilzaehlung_sums_var_samp_fields')
  .props({
    __typename: types.optional(types.literal("garten_teilzaehlung_sums_var_samp_fields"), "garten_teilzaehlung_sums_var_samp_fields"),
...
export class garten_teilzaehlung_sums_var_samp_fieldsModelSelector extends QueryBuilder {
