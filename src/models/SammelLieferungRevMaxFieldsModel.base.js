...
/**
 * SammelLieferungRevMaxFieldsBase
 * auto generated base class for the model SammelLieferungRevMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const SammelLieferungRevMaxFieldsModelBase = ModelBase
  .named('SammelLieferungRevMaxFields')
  .props({
...
export class SammelLieferungRevMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammelLieferungRevMaxFields() {
  return new SammelLieferungRevMaxFieldsModelSelector()
}

export const sammelLieferungRevMaxFieldsModelPrimitives = selectFromSammelLieferungRevMaxFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.datum.gramm_samen.nach_kultur_id.person_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
