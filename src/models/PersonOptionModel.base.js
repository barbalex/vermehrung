...
/**
 * PersonOptionBase
 * auto generated base class for the model PersonOptionModel.
 *
 * columns and relationships of "person_option"
 */
export const PersonOptionModelBase = ModelBase
  .named('PersonOption')
  .props({
...
export class PersonOptionModelSelector extends QueryBuilder {
...
export function selectFromPersonOption() {
  return new PersonOptionModelSelector()
}

export const personOptionModelPrimitives = selectFromPersonOption()._conflicts._depth._parent_rev._rev._revisions.ar_name_deutsch.ga_aktiv.ga_bemerkungen.ga_geom_point.ga_lat_lng.ga_ort.ga_plz.ga_strasse.hk_bemerkungen.hk_geom_point.hk_kanton.hk_land.li_show_sl.li_show_sl_felder.person_id.sl_auto_copy_edits.sl_show_empty_when_next_to_li.tree_event.tree_kultur.tree_lieferung.tree_teilkultur.tree_zaehlung
