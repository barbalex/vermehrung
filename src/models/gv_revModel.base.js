 ...
 */
export const gv_revModelBase = ModelBase
  .named('gv_rev')
  .props({
...
export const gv_revModelPrimitives = selectFromgv_rev()._deleted._depth._parent_rev._rev._rev_at._revisions.changed.changed_by.garten_id.gv_id.person_id
