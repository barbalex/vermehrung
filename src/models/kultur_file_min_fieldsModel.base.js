...
export const kultur_file_min_fieldsModelPrimitives = selectFromkultur_file_min_fields()._rev_at.beschreibung.changed.file_id.file_mime_type.kultur_id.name
