...
export const kultur_option_rev_max_fieldsModelPrimitives = selectFromkultur_option_rev_max_fields()._depth._parent_rev._rev._rev_at.changed.changed_by.kultur_id
