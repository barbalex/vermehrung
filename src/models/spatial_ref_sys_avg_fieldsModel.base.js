...
export class spatial_ref_sys_avg_fieldsModelSelector extends QueryBuilder {
  get auth_srid() { return this.__attr(`auth_srid`) }
  get srid() { return this.__attr(`srid`) }
}
export function selectFromspatial_ref_sys_avg_fields() {
  return new spatial_ref_sys_avg_fieldsModelSelector()
}

export const spatial_ref_sys_avg_fieldsModelPrimitives = selectFromspatial_ref_sys_avg_fields().auth_srid.srid
