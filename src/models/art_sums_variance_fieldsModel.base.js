...
/**
 * art_sums_variance_fieldsBase
 * auto generated base class for the model art_sums_variance_fieldsModel.
 *
 * aggregate variance on columns
 */
export const art_sums_variance_fieldsModelBase = ModelBase
  .named('art_sums_variance_fields')
  .props({
...
export class art_sums_variance_fieldsModelSelector extends QueryBuilder {
...
export function selectFromart_sums_variance_fields() {
  return new art_sums_variance_fieldsModelSelector()
}

export const art_sums_variance_fieldsModelPrimitives = selectFromart_sums_variance_fields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
