...
/**
 * ArtSumsStddevSampFieldsBase
 * auto generated base class for the model ArtSumsStddevSampFieldsModel.
 *
 * aggregate stddev_samp on columns
 */
export const ArtSumsStddevSampFieldsModelBase = ModelBase
  .named('ArtSumsStddevSampFields')
  .props({
...
export class ArtSumsStddevSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromArtSumsStddevSampFields() {
  return new ArtSumsStddevSampFieldsModelSelector()
}

export const artSumsStddevSampFieldsModelPrimitives = selectFromArtSumsStddevSampFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
