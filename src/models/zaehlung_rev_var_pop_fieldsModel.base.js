...
export class zaehlung_rev_var_pop_fieldsModelSelector extends QueryBuilder {
  get _depth() { return this.__attr(`_depth`) }
  get _rev_at() { return this.__attr(`_rev_at`) }
}
export function selectFromzaehlung_rev_var_pop_fields() {
  return new zaehlung_rev_var_pop_fieldsModelSelector()
}

export const zaehlung_rev_var_pop_fieldsModelPrimitives = selectFromzaehlung_rev_var_pop_fields()._depth._rev_at
