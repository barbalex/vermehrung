...
export const kultur_max_fieldsModelPrimitives = selectFromkultur_max_fields()._depth._parent_rev._rev.art_id.bemerkungen.changed.changed_by.garten_id.herkunft_id.von_anzahl_individuen
