...
/**
 * art_sums_stddev_fieldsBase
 * auto generated base class for the model art_sums_stddev_fieldsModel.
 */
export const art_sums_stddev_fieldsModelBase = ModelBase
  .named('art_sums_stddev_fields')
  .props({
...
export class art_sums_stddev_fieldsModelSelector extends QueryBuilder {
...
export function selectFromart_sums_stddev_fields() {
  return new art_sums_stddev_fieldsModelSelector()
}

export const art_sums_stddev_fieldsModelPrimitives = selectFromart_sums_stddev_fields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
