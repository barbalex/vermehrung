...
/**
 * TeilzaehlungMaxFieldsBase
 * auto generated base class for the model TeilzaehlungMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const TeilzaehlungMaxFieldsModelBase = ModelBase
  .named('TeilzaehlungMaxFields')
  .props({
...
export class TeilzaehlungMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromTeilzaehlungMaxFields() {
  return new TeilzaehlungMaxFieldsModelSelector()
}

export const teilzaehlungMaxFieldsModelPrimitives = selectFromTeilzaehlungMaxFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.auspflanzbereit_beschreibung.bemerkungen.changed.changed_by.prognose_von_tz.teilkultur_id.zaehlung_id
