...
/**
 * PersonMaxFieldsBase
 * auto generated base class for the model PersonMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const PersonMaxFieldsModelBase = ModelBase
  .named('PersonMaxFields')
  .props({
...
export class PersonMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromPersonMaxFields() {
  return new PersonMaxFieldsModelSelector()
}

export const personMaxFieldsModelPrimitives = selectFromPersonMaxFields()._depth._parent_rev._rev.account_id.adresszusatz.bemerkungen.changed.changed_by.email.name.nr.ort.plz.strasse.telefon_geschaeft.telefon_mobile.telefon_privat.user_role
