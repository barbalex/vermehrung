 ...
 */
export const garten_fileModelBase = ModelBase.named('garten_file')
  .props({
...
export const garten_fileModelPrimitives = selectFromgarten_file()._rev_at
  .beschreibung.changed.file_id.file_mime_type.garten_id.name
