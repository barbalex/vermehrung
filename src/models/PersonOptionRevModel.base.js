...
/**
 * PersonOptionRevBase
 * auto generated base class for the model PersonOptionRevModel.
 *
 * columns and relationships of "person_option_rev"
 */
export const PersonOptionRevModelBase = ModelBase
  .named('PersonOptionRev')
  .props({
    __typename: types.optional(types.literal("person_option_rev"), "person_option_rev"),
...
export class PersonOptionRevModelSelector extends QueryBuilder {
...
export function selectFromPersonOptionRev() {
  return new PersonOptionRevModelSelector()
}

export const personOptionRevModelPrimitives = selectFromPersonOptionRev()._deleted._depth._parent_rev._rev._revisions.ar_name_deutsch.ga_aktiv.ga_bemerkungen.ga_geom_point.ga_lat_lng.ga_ort.ga_plz.ga_strasse.hk_bemerkungen.hk_geom_point.hk_kanton.hk_land.li_show_sl.li_show_sl_felder.person_id.sl_auto_copy_edits.sl_show_empty_when_next_to_li.tree_event.tree_kultur.tree_lieferung.tree_teilkultur.tree_zaehlung
