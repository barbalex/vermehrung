...
/**
 * HerkunftMaxFieldsBase
 * auto generated base class for the model HerkunftMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const HerkunftMaxFieldsModelBase = ModelBase
  .named('HerkunftMaxFields')
  .props({
...
export class HerkunftMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftMaxFields() {
  return new HerkunftMaxFieldsModelSelector()
}

export const herkunftMaxFieldsModelPrimitives = selectFromHerkunftMaxFields().bemerkungen.changed.changed_by.gemeinde.kanton.land.lokalname.lv95_x.lv95_y.nr.wgs84_lat.wgs84_long
