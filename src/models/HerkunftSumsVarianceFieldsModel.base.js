...
/**
 * HerkunftSumsVarianceFieldsBase
 * auto generated base class for the model HerkunftSumsVarianceFieldsModel.
 *
 * aggregate variance on columns
 */
export const HerkunftSumsVarianceFieldsModelBase = ModelBase
  .named('HerkunftSumsVarianceFields')
  .props({
...
export class HerkunftSumsVarianceFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftSumsVarianceFields() {
  return new HerkunftSumsVarianceFieldsModelSelector()
}

export const herkunftSumsVarianceFieldsModelPrimitives = selectFromHerkunftSumsVarianceFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
