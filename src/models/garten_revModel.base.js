...
export const garten_revModelPrimitives = selectFromgarten_rev()._deleted._depth._parent_rev._rev._rev_at._revisions.aktiv.bemerkungen.changed.changed_by.garten_id.geom_point.name.ort.person_id.plz.strasse
