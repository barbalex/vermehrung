...
/**
 * TeilzaehlungRevMinFieldsBase
 * auto generated base class for the model TeilzaehlungRevMinFieldsModel.
 *
 * aggregate min on columns
 */
export const TeilzaehlungRevMinFieldsModelBase = ModelBase
  .named('TeilzaehlungRevMinFields')
  .props({
...
export class TeilzaehlungRevMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromTeilzaehlungRevMinFields() {
  return new TeilzaehlungRevMinFieldsModelSelector()
}

export const teilzaehlungRevMinFieldsModelPrimitives = selectFromTeilzaehlungRevMinFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.auspflanzbereit_beschreibung.bemerkungen.changed.changed_by.prognose_von_tz.teilkultur_id.zaehlung_id
