...
export class herkunft_variance_fieldsModelSelector extends QueryBuilder {
...
export function selectFromherkunft_variance_fields() {
  return new herkunft_variance_fieldsModelSelector()
}

export const herkunft_variance_fieldsModelPrimitives = selectFromherkunft_variance_fields()._depth._rev_at.lv95_x.lv95_y.wgs84_lat.wgs84_long
