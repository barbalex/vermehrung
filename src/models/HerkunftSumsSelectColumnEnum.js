...
/**
* HerkunftSumsSelectColumn
 *
 * select columns of table "herkunft_sums"
*/
export const HerkunftSumsSelectColumnEnum = types.enumeration("HerkunftSumsSelectColumn", [
        "action", // column name
  ...
  "partitioner", // column name
  "prognose", // column name
  "sum_anzahl_auspflanzbereit", // column name
  "sum_anzahl_pflanzen", // column name
