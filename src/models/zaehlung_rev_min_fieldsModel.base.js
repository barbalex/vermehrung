...
export class zaehlung_rev_min_fieldsModelSelector extends QueryBuilder {
...
export const zaehlung_rev_min_fieldsModelPrimitives = selectFromzaehlung_rev_min_fields()._depth._parent_rev._rev._rev_at.bemerkungen.changed.changed_by.datum.kultur_id.zaehlung_id
