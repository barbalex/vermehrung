...
export const person_rev_min_fieldsModelPrimitives = selectFromperson_rev_min_fields()._depth._parent_rev._rev._rev_at.account_id.adresszusatz.bemerkungen.changed.changed_by.email.name.nr.ort.person_id.plz.strasse.telefon_geschaeft.telefon_mobile.telefon_privat.user_role.vorname
