...
/**
 * GartenTeilzaehlungSumsMinFieldsBase
 * auto generated base class for the model GartenTeilzaehlungSumsMinFieldsModel.
 *
 * aggregate min on columns
 */
export const GartenTeilzaehlungSumsMinFieldsModelBase = ModelBase
  .named('GartenTeilzaehlungSumsMinFields')
  .props({
...
export class GartenTeilzaehlungSumsMinFieldsModelSelector extends QueryBuilder {
