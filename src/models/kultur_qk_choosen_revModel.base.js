 ...
 */
export const kultur_qk_choosen_revModelBase = ModelBase.named(
  'kultur_qk_choosen_rev',
)
  .props({
    __typename: types.optional(
      types.literal('kultur_qk_choosen_rev'),
      'kultur_qk_choosen_rev',
    ),
...
export const kultur_qk_choosen_revModelPrimitives = selectFromkultur_qk_choosen_rev()
  ._deleted._depth._parent_rev._rev._revisions.changed.changed_by.choosen
  .kultur_id.kultur_qk_choosen_id.qk_name
