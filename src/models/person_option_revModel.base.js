 ...
 */
export const person_option_revModelBase = ModelBase.named('person_option_rev')
  .props({
    __typename: types.optional(
      types.literal('person_option_rev'),
      'person_option_rev',
    ),
    ...
    id: types.identifier,
    ku_erhaltungskultur: types.union(
      types.undefined,
      types.null,
      types.boolean,
    ),
...
export class person_option_revModelSelector extends QueryBuilder {
  get _deleted() {
  ...
  get ar_name_deutsch() {
    return this.__attr(`ar_name_deutsch`)
  }
  get changed() {
  ...
  get ga_aktiv() {
    return this.__attr(`ga_aktiv`)
  }
  get ga_bemerkungen() {
    return this.__attr(`ga_bemerkungen`)
  }
  get ga_geom_point() {
    return this.__attr(`ga_geom_point`)
  }
  get ga_lat_lng() {
    return this.__attr(`ga_lat_lng`)
  }
  get ga_ort() {
    return this.__attr(`ga_ort`)
  }
  get ga_plz() {
    return this.__attr(`ga_plz`)
  }
  get ga_strasse() {
    return this.__attr(`ga_strasse`)
  }
  get hk_bemerkungen() {
    return this.__attr(`hk_bemerkungen`)
  }
  get hk_geom_point() {
    return this.__attr(`hk_geom_point`)
  }
  get hk_kanton() {
    return this.__attr(`hk_kanton`)
  }
  get hk_land() {
    return this.__attr(`hk_land`)
  }
  get id() {
    return this.__attr(`id`)
  }
  get ku_erhaltungskultur() {
    return this.__attr(`ku_erhaltungskultur`)
  }
  get ku_zwischenlager() {
    return this.__attr(`ku_zwischenlager`)
  }
  get li_show_sl() {
    return this.__attr(`li_show_sl`)
  }
  get li_show_sl_felder() {
    return this.__attr(`li_show_sl_felder`)
  }
  get person_id() {
    return this.__attr(`person_id`)
  }
  get sl_auto_copy_edits() {
    return this.__attr(`sl_auto_copy_edits`)
  }
  get sl_show_empty_when_next_to_li() {
    return this.__attr(`sl_show_empty_when_next_to_li`)
  }
  get tree_event() {
    return this.__attr(`tree_event`)
  }
  get tree_kultur() {
    return this.__attr(`tree_kultur`)
  }
  get tree_lieferung() {
    return this.__attr(`tree_lieferung`)
  }
  get tree_teilkultur() {
    return this.__attr(`tree_teilkultur`)
  }
  get tree_zaehlung() {
    return this.__attr(`tree_zaehlung`)
  }
}
export function selectFromperson_option_rev() {
  return new person_option_revModelSelector()
}

export const person_option_revModelPrimitives = selectFromperson_option_rev()
  ._deleted._depth._parent_rev._rev._rev_at._revisions.ar_name_deutsch.changed
  .changed_by.ga_aktiv.ga_bemerkungen.ga_geom_point.ga_lat_lng.ga_ort.ga_plz
  .ga_strasse.hk_bemerkungen.hk_geom_point.hk_kanton.hk_land.ku_erhaltungskultur
  .ku_zwischenlager.li_show_sl.li_show_sl_felder.person_id.sl_auto_copy_edits
  .sl_show_empty_when_next_to_li.tree_event.tree_kultur.tree_lieferung
  .tree_teilkultur.tree_zaehlung
