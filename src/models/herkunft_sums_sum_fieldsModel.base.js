...
/**
 * herkunft_sums_sum_fieldsBase
 * auto generated base class for the model herkunft_sums_sum_fieldsModel.
 *
 * aggregate sum on columns
 */
export const herkunft_sums_sum_fieldsModelBase = ModelBase
  .named('herkunft_sums_sum_fields')
  .props({
...
export class herkunft_sums_sum_fieldsModelSelector extends QueryBuilder {
...
export function selectFromherkunft_sums_sum_fields() {
  return new herkunft_sums_sum_fieldsModelSelector()
}

export const herkunft_sums_sum_fieldsModelPrimitives = selectFromherkunft_sums_sum_fields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
