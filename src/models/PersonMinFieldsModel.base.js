...
/**
 * PersonMinFieldsBase
 * auto generated base class for the model PersonMinFieldsModel.
 *
 * aggregate min on columns
 */
export const PersonMinFieldsModelBase = ModelBase
  .named('PersonMinFields')
  .props({
    __typename: types.optional(types.literal("person_min_fields"), "person_min_fields"),
...
export class PersonMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromPersonMinFields() {
  return new PersonMinFieldsModelSelector()
}

export const personMinFieldsModelPrimitives = selectFromPersonMinFields()._depth._parent_rev._rev.account_id.adresszusatz.bemerkungen.changed.changed_by.email.name.nr.ort.plz.strasse.telefon_geschaeft.telefon_mobile.telefon_privat.user_role
