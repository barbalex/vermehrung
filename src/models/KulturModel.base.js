...
export const kulturModelBase = ModelBase
  ...
  .props({
    ...
    kultur_option_revs_aggregate: types.union(types.undefined, types.late(() => kultur_option_rev_aggregateModel)),
    ...
    lieferungRevsByNachKulturId_aggregate: types.union(types.undefined, types.late(() => lieferung_rev_aggregateModel)),
    ...
    sammelLieferungRevsByVonKulturId_aggregate: types.union(types.undefined, types.late(() => sammel_lieferung_rev_aggregateModel)),
