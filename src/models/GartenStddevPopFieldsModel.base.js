...
/**
 * GartenStddevPopFieldsBase
 * auto generated base class for the model GartenStddevPopFieldsModel.
 *
 * aggregate stddev_pop on columns
 */
export const GartenStddevPopFieldsModelBase = ModelBase
  .named('GartenStddevPopFields')
  .props({
...
export class GartenStddevPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromGartenStddevPopFields() {
  return new GartenStddevPopFieldsModelSelector()
}

export const gartenStddevPopFieldsModelPrimitives = selectFromGartenStddevPopFields()._depth.lv95_x.lv95_y.plz.wgs84_lat.wgs84_long
