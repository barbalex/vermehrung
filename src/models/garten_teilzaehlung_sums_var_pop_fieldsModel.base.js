...
/**
 * garten_teilzaehlung_sums_var_pop_fieldsBase
 * auto generated base class for the model garten_teilzaehlung_sums_var_pop_fieldsModel.
 *
 * aggregate var_pop on columns
 */
export const garten_teilzaehlung_sums_var_pop_fieldsModelBase = ModelBase
  .named('garten_teilzaehlung_sums_var_pop_fields')
  .props({
    __typename: types.optional(types.literal("garten_teilzaehlung_sums_var_pop_fields"), "garten_teilzaehlung_sums_var_pop_fields"),
...
export class garten_teilzaehlung_sums_var_pop_fieldsModelSelector extends QueryBuilder {
