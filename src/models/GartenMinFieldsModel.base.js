...
/**
 * GartenMinFieldsBase
 * auto generated base class for the model GartenMinFieldsModel.
 *
 * aggregate min on columns
 */
export const GartenMinFieldsModelBase = ModelBase
  .named('GartenMinFields')
  .props({
...
export class GartenMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromGartenMinFields() {
  return new GartenMinFieldsModelSelector()
}

export const gartenMinFieldsModelPrimitives = selectFromGartenMinFields()._depth._parent_rev._rev.bemerkungen.changed.changed_by.lv95_x.lv95_y.name.ort.person_id.plz.strasse.wgs84_lat.wgs84_long
