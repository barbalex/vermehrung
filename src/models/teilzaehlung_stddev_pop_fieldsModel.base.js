...
export class teilzaehlung_stddev_pop_fieldsModelSelector extends QueryBuilder {
...
export function selectFromteilzaehlung_stddev_pop_fields() {
  return new teilzaehlung_stddev_pop_fieldsModelSelector()
}

export const teilzaehlung_stddev_pop_fieldsModelPrimitives = selectFromteilzaehlung_stddev_pop_fields()._depth._rev_at.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen
