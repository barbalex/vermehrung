...
/**
 * person_max_fieldsBase
 * auto generated base class for the model person_max_fieldsModel.
 */
export const person_max_fieldsModelBase = ModelBase
  .named('person_max_fields')
  .props({
    __typename: types.optional(types.literal("person_max_fields"), "person_max_fields"),
...
export class person_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromperson_max_fields() {
  return new person_max_fieldsModelSelector()
}

export const person_max_fieldsModelPrimitives = selectFromperson_max_fields()._depth._parent_rev._rev._rev_at.account_id.adresszusatz.bemerkungen.changed.changed_by.email.name.nr.ort.plz.strasse.telefon_geschaeft.telefon_mobile.telefon_privat.user_role.user_role_id.vorname
