...
/**
 * herkunft_var_samp_fieldsBase
 * auto generated base class for the model herkunft_var_samp_fieldsModel.
 *
 * aggregate var_samp on columns
 */
export const herkunft_var_samp_fieldsModelBase = ModelBase
  .named('herkunft_var_samp_fields')
  .props({
...
export function selectFromherkunft_var_samp_fields() {
  return new herkunft_var_samp_fieldsModelSelector()
}

export const herkunft_var_samp_fieldsModelPrimitives = selectFromherkunft_var_samp_fields().lv95_x.lv95_y.wgs84_lat.wgs84_long
