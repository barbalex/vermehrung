...
export const kultur_qk_choosen_min_fieldsModelPrimitives = selectFromkultur_qk_choosen_min_fields()._depth._parent_rev._rev._rev_at.changed.changed_by.kultur_id.qk_name
