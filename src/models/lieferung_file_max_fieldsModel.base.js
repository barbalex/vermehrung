...
export const lieferung_file_max_fieldsModelPrimitives = selectFromlieferung_file_max_fields().beschreibung.changed.file_id.file_mime_type.lieferung_id.name
