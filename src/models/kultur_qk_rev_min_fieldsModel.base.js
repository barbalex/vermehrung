...
export const kultur_qk_rev_min_fieldsModelPrimitives = selectFromkultur_qk_rev_min_fields()._depth._parent_rev._rev._rev_at.beschreibung.changed.changed_by.kultur_qk_id.name.sort.titel
