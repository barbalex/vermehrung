...
/**
 * teilzaehlung_max_fieldsBase
 * auto generated base class for the model teilzaehlung_max_fieldsModel.
 */
export const teilzaehlung_max_fieldsModelBase = ModelBase
  .named('teilzaehlung_max_fields')
  .props({
    __typename: types.optional(types.literal("teilzaehlung_max_fields"), "teilzaehlung_max_fields"),
...
export class teilzaehlung_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromteilzaehlung_max_fields() {
  return new teilzaehlung_max_fieldsModelSelector()
}

export const teilzaehlung_max_fieldsModelPrimitives = selectFromteilzaehlung_max_fields()._depth._parent_rev._rev._rev_at.andere_menge.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.auspflanzbereit_beschreibung.bemerkungen.changed.changed_by.prognose_von_tz.teilkultur_id.zaehlung_id
