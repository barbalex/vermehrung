...
export const zaehlung_min_fieldsModelPrimitives = selectFromzaehlung_min_fields()._depth._parent_rev._rev._rev_at.bemerkungen.changed.changed_by.datum.kultur_id
