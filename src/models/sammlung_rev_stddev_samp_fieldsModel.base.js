...
export const sammlung_rev_stddev_samp_fieldsModelPrimitives = selectFromsammlung_rev_stddev_samp_fields()._depth._rev_at.anzahl_pflanzen.gramm_samen.von_anzahl_individuen
