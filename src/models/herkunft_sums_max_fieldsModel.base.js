...
/**
 * herkunft_sums_max_fieldsBase
 * auto generated base class for the model herkunft_sums_max_fieldsModel.
 */
export const herkunft_sums_max_fieldsModelBase = ModelBase
  .named('herkunft_sums_max_fields')
  .props({
    __typename: types.optional(types.literal("herkunft_sums_max_fields"), "herkunft_sums_max_fields"),
...
export class herkunft_sums_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromherkunft_sums_max_fields() {
  return new herkunft_sums_max_fieldsModelSelector()
}

export const herkunft_sums_max_fieldsModelPrimitives = selectFromherkunft_sums_max_fields().action.andere_menge.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.art_id.auspflanzbereit_beschreibung.bemerkungen.datum.gramm_samen.herkunft_id.partitioner.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
