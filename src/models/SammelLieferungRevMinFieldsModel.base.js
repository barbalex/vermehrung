...
/**
 * SammelLieferungRevMinFieldsBase
 * auto generated base class for the model SammelLieferungRevMinFieldsModel.
 *
 * aggregate min on columns
 */
export const SammelLieferungRevMinFieldsModelBase = ModelBase
  .named('SammelLieferungRevMinFields')
  .props({
...
export class SammelLieferungRevMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammelLieferungRevMinFields() {
  return new SammelLieferungRevMinFieldsModelSelector()
}

export const sammelLieferungRevMinFieldsModelPrimitives = selectFromSammelLieferungRevMinFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.datum.gramm_samen.nach_kultur_id.person_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
