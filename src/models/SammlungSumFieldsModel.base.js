...
/**
 * SammlungSumFieldsBase
 * auto generated base class for the model SammlungSumFieldsModel.
 *
 * aggregate sum on columns
 */
export const SammlungSumFieldsModelBase = ModelBase
  .named('SammlungSumFields')
  .props({
...
export class SammlungSumFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammlungSumFields() {
  return new SammlungSumFieldsModelSelector()
}

export const sammlungSumFieldsModelPrimitives = selectFromSammlungSumFields()._depth.anzahl_pflanzen.gramm_samen.lv95_x.lv95_y.von_anzahl_individuen.wgs84_lat.wgs84_long
