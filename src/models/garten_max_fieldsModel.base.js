...
/**
 * garten_max_fieldsBase
 * auto generated base class for the model garten_max_fieldsModel.
 */
export const garten_max_fieldsModelBase = ModelBase
  .named('garten_max_fields')
  .props({
...
export class garten_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromgarten_max_fields() {
  return new garten_max_fieldsModelSelector()
}

export const garten_max_fieldsModelPrimitives = selectFromgarten_max_fields()._depth._parent_rev._rev._rev_at.bemerkungen.changed.changed_by.lv95_x.lv95_y.name.ort.person_id.plz.strasse.wgs84_lat.wgs84_long
