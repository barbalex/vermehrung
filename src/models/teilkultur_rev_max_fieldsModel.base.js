...
export const teilkultur_rev_max_fieldsModelPrimitives = selectFromteilkultur_rev_max_fields()._depth._parent_rev._rev._rev_at.bemerkungen.changed.changed_by.kultur_id.name.ort1.ort2.ort3.teilkultur_id
