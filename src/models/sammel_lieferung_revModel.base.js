 ...
 */
export const sammel_lieferung_revModelBase = ModelBase.named(
  'sammel_lieferung_rev',
)
  .props({
    __typename: types.optional(
      types.literal('sammel_lieferung_rev'),
      'sammel_lieferung_rev',
    ),
    ...
    sammel_lieferung_id: types.union(types.undefined, types.frozen()),
...
export class sammel_lieferung_revModelSelector extends QueryBuilder {
  ...
  get nach_ausgepflanzt() {
    return this.__attr(`nach_ausgepflanzt`)
  }
  get nach_kultur_id() {
    return this.__attr(`nach_kultur_id`)
  }
  get person_id() {
    return this.__attr(`person_id`)
  }
  get sammel_lieferung_id() {
    return this.__attr(`sammel_lieferung_id`)
  }
  get von_anzahl_individuen() {
    return this.__attr(`von_anzahl_individuen`)
  }
  get von_kultur_id() {
    return this.__attr(`von_kultur_id`)
  }
  get von_sammlung_id() {
    return this.__attr(`von_sammlung_id`)
  }
}
...
export const sammel_lieferung_revModelPrimitives = selectFromsammel_lieferung_rev()
  ._deleted._depth._parent_rev._rev._revisions.andere_menge
  .anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by
  .datum.geplant.gramm_samen.nach_ausgepflanzt.nach_kultur_id.person_id
  .sammel_lieferung_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
