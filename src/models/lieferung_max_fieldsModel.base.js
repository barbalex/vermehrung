...
/**
 * lieferung_max_fieldsBase
 * auto generated base class for the model lieferung_max_fieldsModel.
 */
export const lieferung_max_fieldsModelBase = ModelBase
  .named('lieferung_max_fields')
  .props({
    __typename: types.optional(types.literal("lieferung_max_fields"), "lieferung_max_fields"),
...
export class lieferung_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromlieferung_max_fields() {
  return new lieferung_max_fieldsModelSelector()
}

export const lieferung_max_fieldsModelPrimitives = selectFromlieferung_max_fields()._depth._parent_rev._rev._rev_at.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.nach_kultur_id.person_id.sammel_lieferung_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
