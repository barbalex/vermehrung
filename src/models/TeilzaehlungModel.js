...
export const teilzaehlungModel = teilzaehlungModelBase
    ...
    edit({ field, value }) {
      ...
      const newObject = {
        ...
        anzahl_mutterpflanzen:
          field === 'anzahl_mutterpflanzen'
            ? value
            : self.anzahl_mutterpflanzen,
        andere_menge:
          field === 'andere_menge'
  ...
  .views((self) => ({
    get anzahl_jungpflanzen() {
      if (
        exists(self.anzahl_pflanzen) &&
        exists(self.anzahl_auspflanzbereit) &&
        exists(self.anzahl_mutterpflanzen)
      ) {
        return (
          self.anzahl_pflanzen -
          self.anzahl_auspflanzbereit -
          self.anzahl_mutterpflanzen
        )
      }
