...
/**
 * GartenTeilzaehlungSumsStddevFieldsBase
 * auto generated base class for the model GartenTeilzaehlungSumsStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const GartenTeilzaehlungSumsStddevFieldsModelBase = ModelBase
  .named('GartenTeilzaehlungSumsStddevFields')
  .props({
    __typename: types.optional(types.literal("garten_teilzaehlung_sums_stddev_fields"), "garten_teilzaehlung_sums_stddev_fields"),
...
export class GartenTeilzaehlungSumsStddevFieldsModelSelector extends QueryBuilder {
