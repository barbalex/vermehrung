...
/**
 * HerkunftSumsVarSampFieldsBase
 * auto generated base class for the model HerkunftSumsVarSampFieldsModel.
 *
 * aggregate var_samp on columns
 */
export const HerkunftSumsVarSampFieldsModelBase = ModelBase
  .named('HerkunftSumsVarSampFields')
  .props({
...
export class HerkunftSumsVarSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftSumsVarSampFields() {
  return new HerkunftSumsVarSampFieldsModelSelector()
}

export const herkunftSumsVarSampFieldsModelPrimitives = selectFromHerkunftSumsVarSampFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
