...
/**
 * sammel_lieferungBase
 * auto generated base class for the model sammel_lieferungModel.
 */
export const sammel_lieferungModelBase = ModelBase.named('sammel_lieferung')
  .props({
    __typename: types.optional(
      types.literal('sammel_lieferung'),
      'sammel_lieferung',
    ),
...
export function selectFromsammel_lieferung() {
  return new sammel_lieferungModelSelector()
}

export const sammel_lieferungModelPrimitives = selectFromsammel_lieferung()
  ._conflicts._deleted._depth._parent_rev._rev._rev_at._revisions.andere_menge
  ...
  .von_anzahl_individuen.von_kultur_id.von_sammlung_id
