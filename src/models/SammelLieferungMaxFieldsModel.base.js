...
/**
 * SammelLieferungMaxFieldsBase
 * auto generated base class for the model SammelLieferungMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const SammelLieferungMaxFieldsModelBase = ModelBase
  .named('SammelLieferungMaxFields')
  .props({
...
export class SammelLieferungMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammelLieferungMaxFields() {
  return new SammelLieferungMaxFieldsModelSelector()
}

export const sammelLieferungMaxFieldsModelPrimitives = selectFromSammelLieferungMaxFields()._depth._parent_rev._rev.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.datum.gramm_samen.nach_kultur_id.person_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
