...
export const person_rev_max_fieldsModelPrimitives = selectFromperson_rev_max_fields()._depth._parent_rev._rev._rev_at.account_id.adresszusatz.bemerkungen.changed.changed_by.email.name.nr.ort.person_id.plz.strasse.telefon_geschaeft.telefon_mobile.telefon_privat.user_role.vorname
