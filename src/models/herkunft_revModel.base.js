 ...
 */
export const herkunft_revModelBase = ModelBase.named('herkunft_rev')
  .props({
...
export const herkunft_revModelPrimitives = selectFromherkunft_rev()._deleted
  ._depth._parent_rev._rev._rev_at._revisions.bemerkungen.changed.changed_by
  .gemeinde.geom_point.herkunft_id.kanton.land.lokalname.nr
