...
/**
 * HerkunftStddevFieldsBase
 * auto generated base class for the model HerkunftStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const HerkunftStddevFieldsModelBase = ModelBase
  .named('HerkunftStddevFields')
  .props({
...
export class HerkunftStddevFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftStddevFields() {
  return new HerkunftStddevFieldsModelSelector()
}

export const herkunftStddevFieldsModelPrimitives = selectFromHerkunftStddevFields().lv95_x.lv95_y.wgs84_lat.wgs84_long
