...
export const person_revModelPrimitives = selectFromperson_rev()._deleted._depth._parent_rev._rev._rev_at._revisions.account_id.adresszusatz.aktiv.bemerkungen.changed.changed_by.email.info.kein_email.kommerziell.name.nr.ort.person_id.plz.strasse.telefon_geschaeft.telefon_mobile.telefon_privat.user_role.user_role_id.vorname
