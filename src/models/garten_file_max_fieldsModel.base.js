...
export const garten_file_max_fieldsModelPrimitives = selectFromgarten_file_max_fields()._rev_at.beschreibung.changed.file_id.file_mime_type.garten_id.name
