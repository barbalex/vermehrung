...
export class kultur_rev_stddev_fieldsModelSelector extends QueryBuilder {
  get _depth() { return this.__attr(`_depth`) }
  get _rev_at() { return this.__attr(`_rev_at`) }
  get von_anzahl_individuen() { return this.__attr(`von_anzahl_individuen`) }
}
export function selectFromkultur_rev_stddev_fields() {
  return new kultur_rev_stddev_fieldsModelSelector()
}

export const kultur_rev_stddev_fieldsModelPrimitives = selectFromkultur_rev_stddev_fields()._depth._rev_at.von_anzahl_individuen
