...
export class lieferung_rev_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromlieferung_rev_max_fields() {
  return new lieferung_rev_max_fieldsModelSelector()
}

export const lieferung_rev_max_fieldsModelPrimitives = selectFromlieferung_rev_max_fields()._depth._parent_rev._rev._rev_at.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.lieferung_id.nach_kultur_id.person_id.sammel_lieferung_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
