...
/**
 * sammel_lieferung_rev_var_pop_fieldsBase
 * auto generated base class for the model sammel_lieferung_rev_var_pop_fieldsModel.
 *
 * aggregate var_pop on columns
 */
export const sammel_lieferung_rev_var_pop_fieldsModelBase = ModelBase
  .named('sammel_lieferung_rev_var_pop_fields')
  .props({
...
export function selectFromsammel_lieferung_rev_var_pop_fields() {
