 ...
 */
export const lieferung_revModelBase = ModelBase.named('lieferung_rev')
  .props({
    ...
    id: types.identifier,
    lieferung_id: types.union(types.undefined, types.frozen()),
...
export const lieferung_revModelPrimitives = selectFromlieferung_rev()._deleted
  ._depth._parent_rev._rev._revisions.andere_menge.anzahl_auspflanzbereit
  .anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.geplant
  .gramm_samen.lieferung_id.nach_ausgepflanzt.nach_kultur_id.person_id
