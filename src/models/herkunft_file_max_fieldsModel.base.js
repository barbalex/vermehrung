...
export const herkunft_file_max_fieldsModelPrimitives = selectFromherkunft_file_max_fields()._rev_at.beschreibung.changed.file_id.file_mime_type.herkunft_id.name
