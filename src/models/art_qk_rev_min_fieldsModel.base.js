...
export const art_qk_rev_min_fieldsModelPrimitives = selectFromart_qk_rev_min_fields()._depth._parent_rev._rev.art_qk_id.beschreibung.changed.changed_by.name.sort.titel
