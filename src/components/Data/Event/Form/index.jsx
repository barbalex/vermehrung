...
export const EventForm = ({
  ...
  useEffect(() => {
    ...
    db,
    kulturFilter._deleted,
    kulturFilter.aktiv,
    personFilter._deleted,
    personFilter.aktiv,
    teilkulturFilter._deleted,
    kulturId,
    row,
  ...
  const saveToDb = (event) => {
    ...
    if (showFilter) {
      return setFilterValue({ table: 'event', key: field, value })
    }
  ...
  const showDeleted = eventFilter._deleted !== false || row?._deleted
