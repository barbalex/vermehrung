...
/**
 * HerkunftStddevPopFieldsBase
 * auto generated base class for the model HerkunftStddevPopFieldsModel.
 *
 * aggregate stddev_pop on columns
 */
export const HerkunftStddevPopFieldsModelBase = ModelBase
  .named('HerkunftStddevPopFields')
  .props({
...
export class HerkunftStddevPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftStddevPopFields() {
  return new HerkunftStddevPopFieldsModelSelector()
}

export const herkunftStddevPopFieldsModelPrimitives = selectFromHerkunftStddevPopFields().lv95_x.lv95_y.wgs84_lat.wgs84_long
