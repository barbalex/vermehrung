...
/**
 * SammlungRevMinFieldsBase
 * auto generated base class for the model SammlungRevMinFieldsModel.
 *
 * aggregate min on columns
 */
export const SammlungRevMinFieldsModelBase = ModelBase
  .named('SammlungRevMinFields')
  .props({
...
export class SammlungRevMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromSammlungRevMinFields() {
  return new SammlungRevMinFieldsModelSelector()
}

export const sammlungRevMinFieldsModelPrimitives = selectFromSammlungRevMinFields()._depth._parent_rev._rev.andere_menge.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.herkunft_id.nr.person_id.von_anzahl_individuen
