...
import { PersonArten as Arten } from './Arten/index.jsx'
import { PersonGaerten as Gaerten } from './Gaerten/index.jsx'
...
export const PersonForm = ({
  ...
  const saveToDb = (event) => {
    ...
    if (showFilter) {
      return setFilterValue({ table: 'person', key: field, value })
    }
  ...
  const showDeleted = personFilter._deleted !== false || row?._deleted
