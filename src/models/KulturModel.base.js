...
export const kulturModelBase = ModelBase
  ...
  .props({
    ...
    kultur_files_aggregate: types.union(types.undefined, types.frozen()),
    kultur_option: types.union(types.undefined, types.null, MSTGQLRef(types.late(() => kultur_optionModel))),
    kultur_option_revs: types.union(types.undefined, types.array(MSTGQLRef(types.late(() => kultur_option_revModel)))),
    kultur_option_revs_aggregate: types.union(types.undefined, types.frozen()),
    kultur_qk_choosens: types.union(types.undefined, types.array(MSTGQLRef(types.late(() => kultur_qk_choosenModel)))),
    kultur_qk_choosens_aggregate: types.union(types.undefined, types.frozen()),
    lieferungRevsByNachKulturId: types.union(types.undefined, types.array(MSTGQLRef(types.late(() => lieferung_revModel)))),
    lieferungRevsByNachKulturId_aggregate: types.union(types.undefined, types.frozen()),
    ...
    lieferungsByNachKulturId_aggregate: types.union(types.undefined, types.frozen()),
    lieferungsByVonKulturId: types.union(types.undefined, types.array(MSTGQLRef(types.late(() => lieferungModel)))),
    lieferungsByVonKulturId_aggregate: types.union(types.undefined, types.frozen()),
    sammelLieferungRevsByVonKulturId: types.union(types.undefined, types.array(MSTGQLRef(types.late(() => sammel_lieferung_revModel)))),
    sammelLieferungRevsByVonKulturId_aggregate: types.union(types.undefined, types.frozen()),
    sammelLieferungsByNachKulturId: types.union(types.undefined, types.array(MSTGQLRef(types.late(() => sammel_lieferungModel)))),
    sammelLieferungsByNachKulturId_aggregate: types.union(types.undefined, types.frozen()),
    ...
    teilkultur_revs: types.union(types.undefined, types.array(MSTGQLRef(types.late(() => teilkultur_revModel)))),
    teilkultur_revs_aggregate: types.union(types.undefined, types.frozen()),
    ...
    zaehlung_revs_aggregate: types.union(types.undefined, types.frozen()),
...
export class kulturModelSelector extends QueryBuilder {
  ...
  kultur_option_revs(builder) { return this.__child(`kultur_option_revs`, kultur_option_revModelSelector, builder) }
  kultur_option_revs_aggregate(builder) { return this.__child(`kultur_option_revs_aggregate`, kultur_option_rev_aggregateModelSelector, builder) }
  ...
  lieferungRevsByNachKulturId(builder) { return this.__child(`lieferungRevsByNachKulturId`, lieferung_revModelSelector, builder) }
  lieferungRevsByNachKulturId_aggregate(builder) { return this.__child(`lieferungRevsByNachKulturId_aggregate`, lieferung_rev_aggregateModelSelector, builder) }
  ...
  sammelLieferungRevsByVonKulturId(builder) { return this.__child(`sammelLieferungRevsByVonKulturId`, sammel_lieferung_revModelSelector, builder) }
  sammelLieferungRevsByVonKulturId_aggregate(builder) { return this.__child(`sammelLieferungRevsByVonKulturId_aggregate`, sammel_lieferung_rev_aggregateModelSelector, builder) }
  ...
  teilkultur_revs(builder) { return this.__child(`teilkultur_revs`, teilkultur_revModelSelector, builder) }
  teilkultur_revs_aggregate(builder) { return this.__child(`teilkultur_revs_aggregate`, teilkultur_rev_aggregateModelSelector, builder) }
  ...
  zaehlung_revs(builder) { return this.__child(`zaehlung_revs`, zaehlung_revModelSelector, builder) }
  zaehlung_revs_aggregate(builder) { return this.__child(`zaehlung_revs_aggregate`, zaehlung_rev_aggregateModelSelector, builder) }
...
export const kulturModelPrimitives = selectFromkultur()._conflicts._deleted._depth._parent_rev._rev._rev_at._revisions.aktiv.art_id.bemerkungen.changed.changed_by.erhaltungskultur.garten_id.herkunft_id.von_anzahl_individuen.zwischenlager
