...
export const sammlung_rev_min_fieldsModelPrimitives = selectFromsammlung_rev_min_fields()._depth._parent_rev._rev.andere_menge.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.herkunft_id.nr.person_id.von_anzahl_individuen
