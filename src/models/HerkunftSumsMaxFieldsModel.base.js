...
/**
 * HerkunftSumsMaxFieldsBase
 * auto generated base class for the model HerkunftSumsMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const HerkunftSumsMaxFieldsModelBase = ModelBase
  .named('HerkunftSumsMaxFields')
  .props({
...
export class HerkunftSumsMaxFieldsModelSelector extends QueryBuilder {
