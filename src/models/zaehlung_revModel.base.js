...
export const zaehlung_revModelPrimitives = selectFromzaehlung_rev()._deleted._depth._parent_rev._rev._rev_at._revisions.bemerkungen.changed.changed_by.datum.kultur_id.prognose.zaehlung_id
