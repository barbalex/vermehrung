...
/**
 * sammel_lieferung_rev_max_fieldsBase
 * auto generated base class for the model sammel_lieferung_rev_max_fieldsModel.
 */
export const sammel_lieferung_rev_max_fieldsModelBase = ModelBase
  .named('sammel_lieferung_rev_max_fields')
  .props({
    __typename: types.optional(types.literal("sammel_lieferung_rev_max_fields"), "sammel_lieferung_rev_max_fields"),
...
export class sammel_lieferung_rev_max_fieldsModelSelector extends QueryBuilder {
...
export function selectFromsammel_lieferung_rev_max_fields() {
  return new sammel_lieferung_rev_max_fieldsModelSelector()
}

export const sammel_lieferung_rev_max_fieldsModelPrimitives = selectFromsammel_lieferung_rev_max_fields()._depth._parent_rev._rev._rev_at.andere_menge.anzahl_auspflanzbereit.anzahl_pflanzen.art_id.bemerkungen.changed.changed_by.datum.gramm_samen.nach_kultur_id.person_id.sammel_lieferung_id.von_anzahl_individuen.von_kultur_id.von_sammlung_id
