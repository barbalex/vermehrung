...
export const garten_rev_max_fieldsModelPrimitives = selectFromgarten_rev_max_fields()._depth._parent_rev._rev.bemerkungen.changed.changed_by.name.ort.person_id.plz.strasse
