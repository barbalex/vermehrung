...
/**
 * HerkunftSumsBase
 * auto generated base class for the model HerkunftSumsModel.
 *
 * columns and relationships of "herkunft_sums"
 */
export const HerkunftSumsModelBase = ModelBase
  .named('HerkunftSums')
  .props({
...
export class HerkunftSumsModelSelector extends QueryBuilder {
