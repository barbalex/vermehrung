...
export const teilzaehlung_rev_stddev_samp_fieldsModelPrimitives = selectFromteilzaehlung_rev_stddev_samp_fields()._depth.anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen
