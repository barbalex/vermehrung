...
/**
 * art_sums_var_samp_fieldsBase
 * auto generated base class for the model art_sums_var_samp_fieldsModel.
 */
export const art_sums_var_samp_fieldsModelBase = ModelBase
  .named('art_sums_var_samp_fields')
  .props({
...
export class art_sums_var_samp_fieldsModelSelector extends QueryBuilder {
...
export function selectFromart_sums_var_samp_fields() {
  return new art_sums_var_samp_fieldsModelSelector()
}

export const art_sums_var_samp_fieldsModelPrimitives = selectFromart_sums_var_samp_fields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
