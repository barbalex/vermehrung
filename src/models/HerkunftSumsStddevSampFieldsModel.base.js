...
/**
 * HerkunftSumsStddevSampFieldsBase
 * auto generated base class for the model HerkunftSumsStddevSampFieldsModel.
 *
 * aggregate stddev_samp on columns
 */
export const HerkunftSumsStddevSampFieldsModelBase = ModelBase
  .named('HerkunftSumsStddevSampFields')
  .props({
...
export class HerkunftSumsStddevSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromHerkunftSumsStddevSampFields() {
  return new HerkunftSumsStddevSampFieldsModelSelector()
}

export const herkunftSumsStddevSampFieldsModelPrimitives = selectFromHerkunftSumsStddevSampFields().anzahl_auspflanzbereit.anzahl_mutterpflanzen.anzahl_pflanzen.gramm_samen.sum_anzahl_auspflanzbereit.sum_anzahl_pflanzen.von_anzahl_individuen
