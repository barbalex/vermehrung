...
export const art_qk_min_fieldsModelPrimitives = selectFromart_qk_min_fields()._depth._parent_rev._rev._rev_at.beschreibung.changed.changed_by.name.sort.titel
